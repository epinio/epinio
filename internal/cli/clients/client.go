...
// There are 2 ways this method can be stopped:
// 1. If the connection is closed
// 2. If something is sent to the interrupt channel
...
// 3. the main thread sends to the `done` chan (as a "defer" function), it then
