...
var neededOptions = kubernetes.InstallationOptions{
	...
	},
	{
		...
		Description: "Provide url for an external registry. This disables installation of the internal registry.",
		Type:        kubernetes.StringType,
		Default:     "",
		Value:       "",
	},
	{
		...
		Description: "Provide namespace (or organization) of the external registry to which you have push access. It can be left empty.",
		Type:        kubernetes.StringType,
		Default:     "",
		Value:       "",
	},
	{
		...
		Description: "Provide username for an external registry. This disables installation of the internal registry.",
		Type:        kubernetes.StringType,
		Default:     "",
		Value:       "",
	},
	{
		...
		Description: "Provide password for an external registry. This disables installation of the internal registry.",
		Type:        kubernetes.StringType,
		Default:     "",
		Value:       "",
	},
