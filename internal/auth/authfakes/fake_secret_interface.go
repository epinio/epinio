...
func (fake *FakeSecretInterface) Apply(arg1 context.Context, arg2 *v1a.SecretApplyConfiguration, arg3 v1b.ApplyOptions) (*v1.Secret, error) {
...
func (fake *FakeSecretInterface) ApplyCalls(stub func(context.Context, *v1a.SecretApplyConfiguration, v1b.ApplyOptions) (*v1.Secret, error)) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = stub
}

func (fake *FakeSecretInterface) ApplyArgsForCall(i int) (context.Context, *v1a.SecretApplyConfiguration, v1b.ApplyOptions) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *FakeSecretInterface) ApplyReturns(result1 *v1.Secret, result2 error) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = nil
...
func (fake *FakeSecretInterface) ApplyReturnsOnCall(i int, result1 *v1.Secret, result2 error) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = nil
...
func (fake *FakeSecretInterface) Create(arg1 context.Context, arg2 *v1.Secret, arg3 v1b.CreateOptions) (*v1.Secret, error) {
...
func (fake *FakeSecretInterface) CreateCalls(stub func(context.Context, *v1.Secret, v1b.CreateOptions) (*v1.Secret, error)) {
	fake.createMutex.Lock()
	defer fake.createMutex.Unlock()
	fake.CreateStub = stub
}

func (fake *FakeSecretInterface) CreateArgsForCall(i int) (context.Context, *v1.Secret, v1b.CreateOptions) {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
...
func (fake *FakeSecretInterface) CreateReturns(result1 *v1.Secret, result2 error) {
	fake.createMutex.Lock()
	defer fake.createMutex.Unlock()
	fake.CreateStub = nil
...
func (fake *FakeSecretInterface) CreateReturnsOnCall(i int, result1 *v1.Secret, result2 error) {
	fake.createMutex.Lock()
	defer fake.createMutex.Unlock()
	fake.CreateStub = nil
...
func (fake *FakeSecretInterface) Get(arg1 context.Context, arg2 string, arg3 v1b.GetOptions) (*v1.Secret, error) {
	fake.getMutex.Lock()
...
func (fake *FakeSecretInterface) GetCalls(stub func(context.Context, string, v1b.GetOptions) (*v1.Secret, error)) {
	fake.getMutex.Lock()
...
func (fake *FakeSecretInterface) GetReturns(result1 *v1.Secret, result2 error) {
	fake.getMutex.Lock()
	defer fake.getMutex.Unlock()
	fake.GetStub = nil
...
func (fake *FakeSecretInterface) GetReturnsOnCall(i int, result1 *v1.Secret, result2 error) {
	fake.getMutex.Lock()
	defer fake.getMutex.Unlock()
	fake.GetStub = nil
...
func (fake *FakeSecretInterface) List(arg1 context.Context, arg2 v1b.ListOptions) (*v1.SecretList, error) {
	fake.listMutex.Lock()
...
func (fake *FakeSecretInterface) ListCalls(stub func(context.Context, v1b.ListOptions) (*v1.SecretList, error)) {
	fake.listMutex.Lock()
...
func (fake *FakeSecretInterface) ListReturns(result1 *v1.SecretList, result2 error) {
	fake.listMutex.Lock()
	defer fake.listMutex.Unlock()
	fake.ListStub = nil
...
func (fake *FakeSecretInterface) ListReturnsOnCall(i int, result1 *v1.SecretList, result2 error) {
	fake.listMutex.Lock()
	defer fake.listMutex.Unlock()
	fake.ListStub = nil
...
func (fake *FakeSecretInterface) Patch(arg1 context.Context, arg2 string, arg3 types.PatchType, arg4 []byte, arg5 v1b.PatchOptions, arg6 ...string) (*v1.Secret, error) {
	var arg4Copy []byte
	if arg4 != nil {
...
func (fake *FakeSecretInterface) PatchCalls(stub func(context.Context, string, types.PatchType, []byte, v1b.PatchOptions, ...string) (*v1.Secret, error)) {
	fake.patchMutex.Lock()
...
func (fake *FakeSecretInterface) PatchReturns(result1 *v1.Secret, result2 error) {
	fake.patchMutex.Lock()
	defer fake.patchMutex.Unlock()
	fake.PatchStub = nil
...
func (fake *FakeSecretInterface) PatchReturnsOnCall(i int, result1 *v1.Secret, result2 error) {
	fake.patchMutex.Lock()
	defer fake.patchMutex.Unlock()
	fake.PatchStub = nil
...
func (fake *FakeSecretInterface) Update(arg1 context.Context, arg2 *v1.Secret, arg3 v1b.UpdateOptions) (*v1.Secret, error) {
...
func (fake *FakeSecretInterface) UpdateCalls(stub func(context.Context, *v1.Secret, v1b.UpdateOptions) (*v1.Secret, error)) {
	fake.updateMutex.Lock()
	defer fake.updateMutex.Unlock()
	fake.UpdateStub = stub
}

func (fake *FakeSecretInterface) UpdateArgsForCall(i int) (context.Context, *v1.Secret, v1b.UpdateOptions) {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
...
func (fake *FakeSecretInterface) UpdateReturns(result1 *v1.Secret, result2 error) {
	fake.updateMutex.Lock()
	defer fake.updateMutex.Unlock()
	fake.UpdateStub = nil
...
func (fake *FakeSecretInterface) UpdateReturnsOnCall(i int, result1 *v1.Secret, result2 error) {
	fake.updateMutex.Lock()
	defer fake.updateMutex.Unlock()
	fake.UpdateStub = nil
...
var _ auth.SecretInterface = new(FakeSecretInterface)
