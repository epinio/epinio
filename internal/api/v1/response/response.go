...
func OK(c *gin.Context) {
	tracelog.Logger(c.Request.Context()).Info("OK", "returning", models.ResponseOK)
...
func OKReturn(c *gin.Context, response interface{}) {
	tracelog.Logger(c.Request.Context()).Info("OK", "returning", response)
...
func Created(c *gin.Context) {
	tracelog.Logger(c.Request.Context()).Info("CREATED", "returning", models.ResponseOK)
...
func Error(c *gin.Context, responseErrors errors.APIErrors) {
	tracelog.Logger(c.Request.Context()).Info("ERROR", "error", responseErrors)
