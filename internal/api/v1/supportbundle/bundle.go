...
func Bundle(c *gin.Context) apierror.APIErrors {
	...
	// Get file info for content length. The archive path is generated by the
	// support bundle collector and is not derived from user input.
	//nolint:gosec // G703 - archivePath is an internally-generated path
