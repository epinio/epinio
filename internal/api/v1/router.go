...
import (
	...
	"github.com/epinio/epinio/internal/api/v1/telemetry"
...
var Routes = routes.NamedRoutes{
	...
	"TelemetryPublish": post("/telemetry/publish", errorHandler(telemetry.Publish)),
	...
	"AppSource":       get("/namespaces/:namespace/applications/:app/source", errorHandler(application.GetSource)),
