...
func (m *GetAllFeatureFlagsResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAllFeatureFlagsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *GetAllFeatureFlagsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *GetAllFeatureFlagsResponseResource) UnmarshalBinary(b []byte) error {
	var res GetAllFeatureFlagsResponseResource
