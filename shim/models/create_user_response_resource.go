...
func (m *CreateUserResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreateUserResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreateUserResponseResource) UnmarshalBinary(b []byte) error {
	var res CreateUserResponseResource
