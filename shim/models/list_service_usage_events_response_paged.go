...
func (m *ListServiceUsageEventsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListServiceUsageEventsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListServiceUsageEventsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListServiceUsageEventsResponsePaged
