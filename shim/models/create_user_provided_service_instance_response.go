...
func (m *CreateUserProvidedServiceInstanceResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateUserProvidedServiceInstanceResponse) validateCredentials(formats strfmt.Registry) error {
...
func (m *CreateUserProvidedServiceInstanceResponse) UnmarshalBinary(b []byte) error {
	var res CreateUserProvidedServiceInstanceResponse
