...
func (m *ListServiceUsageEventsResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListServiceUsageEventsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListServiceUsageEventsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListServiceUsageEventsResponseResource) UnmarshalBinary(b []byte) error {
	var res ListServiceUsageEventsResponseResource
