...
func (m *CreateAppResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreateAppResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreateAppResponseResource) UnmarshalBinary(b []byte) error {
	var res CreateAppResponseResource
