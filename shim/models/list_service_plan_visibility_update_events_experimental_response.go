...
func (m *ListServicePlanVisibilityUpdateEventsExperimentalResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListServicePlanVisibilityUpdateEventsExperimentalResponse) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListServicePlanVisibilityUpdateEventsExperimentalResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListServicePlanVisibilityUpdateEventsExperimentalResponse) UnmarshalBinary(b []byte) error {
	var res ListServicePlanVisibilityUpdateEventsExperimentalResponse
