...
func (m *CreateServiceDeprecatedRequest) validateActive(formats strfmt.Registry) error {
...
func (m *CreateServiceDeprecatedRequest) validateBindable(formats strfmt.Registry) error {
...
func (m *CreateServiceDeprecatedRequest) validateTimeout(formats strfmt.Registry) error {
...
func (m *CreateServiceDeprecatedRequest) validateUniqueID(formats strfmt.Registry) error {
...
func (m *CreateServiceDeprecatedRequest) UnmarshalBinary(b []byte) error {
	var res CreateServiceDeprecatedRequest
