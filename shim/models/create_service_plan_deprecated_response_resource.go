...
func (m *CreateServicePlanDeprecatedResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateServicePlanDeprecatedResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreateServicePlanDeprecatedResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreateServicePlanDeprecatedResponseResource) UnmarshalBinary(b []byte) error {
	var res CreateServicePlanDeprecatedResponseResource
