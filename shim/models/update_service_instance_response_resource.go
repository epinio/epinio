...
func (m *UpdateServiceInstanceResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateServiceInstanceResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateServiceInstanceResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateServiceInstanceResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateServiceInstanceResponseResource
