...
func (m *UpdateSpaceResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateSpaceResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateSpaceResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateSpaceResponseResource
