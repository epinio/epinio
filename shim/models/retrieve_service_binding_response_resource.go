...
func (m *RetrieveServiceBindingResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveServiceBindingResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveServiceBindingResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveServiceBindingResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveServiceBindingResponseResource
