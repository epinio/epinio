...
func (m *ListAllServiceInstancesResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServiceInstancesResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllServiceInstancesResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllServiceInstancesResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllServiceInstancesResponseResource
