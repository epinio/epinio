...
func (m *ListAllServicesResponse) validateDocumentationURL(formats strfmt.Registry) error {
...
func (m *ListAllServicesResponse) validateExtra(formats strfmt.Registry) error {
...
func (m *ListAllServicesResponse) validateInfoURL(formats strfmt.Registry) error {
...
func (m *ListAllServicesResponse) validateLongDescription(formats strfmt.Registry) error {
...
func (m *ListAllServicesResponse) validateRequires(formats strfmt.Registry) error {
...
func (m *ListAllServicesResponse) validateTags(formats strfmt.Registry) error {
...
func (m *ListAllServicesResponse) UnmarshalBinary(b []byte) error {
	var res ListAllServicesResponse
