...
func (m *GetOrganizationSummaryResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetOrganizationSummaryResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *GetOrganizationSummaryResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *GetOrganizationSummaryResponseResource) UnmarshalBinary(b []byte) error {
	var res GetOrganizationSummaryResponseResource
