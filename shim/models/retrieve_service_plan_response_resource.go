...
func (m *RetrieveServicePlanResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveServicePlanResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveServicePlanResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveServicePlanResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveServicePlanResponseResource
