...
func (m *ListAllBillingManagersForOrganizationResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ListAllBillingManagersForOrganizationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListAllBillingManagersForOrganizationResponse) UnmarshalBinary(b []byte) error {
	var res ListAllBillingManagersForOrganizationResponse
