...
func (m *UpdateServicePlanDeprecatedResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateServicePlanDeprecatedResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateServicePlanDeprecatedResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateServicePlanDeprecatedResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateServicePlanDeprecatedResponseResource
