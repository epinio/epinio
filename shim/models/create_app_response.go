...
func (m *CreateAppResponse) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePackageUpdatedAt(formats); err != nil {
		res = append(res, err)
	}
...
func (m *CreateAppResponse) validateBuildpack(formats strfmt.Registry) error {
...
func (m *CreateAppResponse) validateCommand(formats strfmt.Registry) error {
...
func (m *CreateAppResponse) validateDebug(formats strfmt.Registry) error {
...
func (m *CreateAppResponse) validateDetectedBuildpack(formats strfmt.Registry) error {
...
func (m *CreateAppResponse) validateDockerImage(formats strfmt.Registry) error {
...
func (m *CreateAppResponse) validateEnvironmentJSON(formats strfmt.Registry) error {
...
func (m *CreateAppResponse) validateHealthCheckTimeout(formats strfmt.Registry) error {
...
func (m *CreateAppResponse) validatePackageUpdatedAt(formats strfmt.Registry) error {

	if swag.IsZero(m.PackageUpdatedAt) { // not required
		return nil
	}

	if err := m.PackageUpdatedAt.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("package_updated_at")
		}
		return err
	}
...
func (m *CreateAppResponse) validateStagingFailedReason(formats strfmt.Registry) error {
...
func (m *CreateAppResponse) validateStagingTaskID(formats strfmt.Registry) error {
