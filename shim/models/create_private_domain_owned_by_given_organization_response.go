...
func (m *CreatePrivateDomainOwnedByGivenOrganizationResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CreatePrivateDomainOwnedByGivenOrganizationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreatePrivateDomainOwnedByGivenOrganizationResponse) UnmarshalBinary(b []byte) error {
	var res CreatePrivateDomainOwnedByGivenOrganizationResponse
