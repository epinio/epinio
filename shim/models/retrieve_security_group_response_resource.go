...
func (m *RetrieveSecurityGroupResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveSecurityGroupResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveSecurityGroupResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveSecurityGroupResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveSecurityGroupResponseResource
