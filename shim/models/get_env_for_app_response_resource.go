...
func (m *GetEnvForAppResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *GetEnvForAppResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *GetEnvForAppResponseResource) UnmarshalBinary(b []byte) error {
	var res GetEnvForAppResponseResource
