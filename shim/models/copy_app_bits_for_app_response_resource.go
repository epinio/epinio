...
func (m *CopyAppBitsForAppResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CopyAppBitsForAppResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CopyAppBitsForAppResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CopyAppBitsForAppResponseResource) UnmarshalBinary(b []byte) error {
	var res CopyAppBitsForAppResponseResource
