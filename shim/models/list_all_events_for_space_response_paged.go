...
func (m *ListAllEventsForSpaceResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllEventsForSpaceResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllEventsForSpaceResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllEventsForSpaceResponsePaged
