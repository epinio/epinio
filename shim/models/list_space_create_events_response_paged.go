...
func (m *ListSpaceCreateEventsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListSpaceCreateEventsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListSpaceCreateEventsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListSpaceCreateEventsResponsePaged
