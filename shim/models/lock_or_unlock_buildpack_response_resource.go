...
func (m *LockOrUnlockBuildpackResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LockOrUnlockBuildpackResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *LockOrUnlockBuildpackResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *LockOrUnlockBuildpackResponseResource) UnmarshalBinary(b []byte) error {
	var res LockOrUnlockBuildpackResponseResource
