...
func (m *RetrieveRouteResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveRouteResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveRouteResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveRouteResponseResource
