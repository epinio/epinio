...
func (m *ListAllServiceInstancesForServicePlanResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServiceInstancesForServicePlanResponse) validateCredentials(formats strfmt.Registry) error {
...
func (m *ListAllServiceInstancesForServicePlanResponse) validateDashboardURL(formats strfmt.Registry) error {
...
func (m *ListAllServiceInstancesForServicePlanResponse) validateGatewayData(formats strfmt.Registry) error {
...
func (m *ListAllServiceInstancesForServicePlanResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListAllServiceInstancesForServicePlanResponse) UnmarshalBinary(b []byte) error {
	var res ListAllServiceInstancesForServicePlanResponse
