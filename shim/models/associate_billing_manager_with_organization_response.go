...
func (m *AssociateBillingManagerWithOrganizationResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *AssociateBillingManagerWithOrganizationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AssociateBillingManagerWithOrganizationResponse) UnmarshalBinary(b []byte) error {
	var res AssociateBillingManagerWithOrganizationResponse
