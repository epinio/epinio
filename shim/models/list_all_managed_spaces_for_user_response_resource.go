...
func (m *ListAllManagedSpacesForUserResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllManagedSpacesForUserResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllManagedSpacesForUserResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllManagedSpacesForUserResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllManagedSpacesForUserResponseResource
