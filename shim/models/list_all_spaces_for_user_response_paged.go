...
func (m *ListAllSpacesForUserResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllSpacesForUserResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllSpacesForUserResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllSpacesForUserResponsePaged
