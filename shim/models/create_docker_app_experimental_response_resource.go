...
func (m *CreateDockerAppExperimentalResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateDockerAppExperimentalResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreateDockerAppExperimentalResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreateDockerAppExperimentalResponseResource) UnmarshalBinary(b []byte) error {
	var res CreateDockerAppExperimentalResponseResource
