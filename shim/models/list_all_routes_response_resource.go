...
func (m *ListAllRoutesResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllRoutesResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllRoutesResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllRoutesResponseResource
