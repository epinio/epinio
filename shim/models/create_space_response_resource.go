...
func (m *CreateSpaceResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreateSpaceResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreateSpaceResponseResource) UnmarshalBinary(b []byte) error {
	var res CreateSpaceResponseResource
