...
func (m *RetrieveServiceBindingResponse) validateBindingOptions(formats strfmt.Registry) error {
...
func (m *RetrieveServiceBindingResponse) validateCredentials(formats strfmt.Registry) error {
...
func (m *RetrieveServiceBindingResponse) validateGatewayData(formats strfmt.Registry) error {
...
func (m *RetrieveServiceBindingResponse) validateSyslogDrainURL(formats strfmt.Registry) error {
...
func (m *RetrieveServiceBindingResponse) UnmarshalBinary(b []byte) error {
	var res RetrieveServiceBindingResponse
