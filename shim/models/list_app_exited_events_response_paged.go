...
func (m *ListAppExitedEventsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAppExitedEventsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAppExitedEventsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAppExitedEventsResponsePaged
