...
func (m *AssociateSpaceWithSpaceQuotaDefinitionResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *AssociateSpaceWithSpaceQuotaDefinitionResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AssociateSpaceWithSpaceQuotaDefinitionResponse) UnmarshalBinary(b []byte) error {
	var res AssociateSpaceWithSpaceQuotaDefinitionResponse
