...
func (m *RetrieveEventResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveEventResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveEventResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveEventResponseResource
