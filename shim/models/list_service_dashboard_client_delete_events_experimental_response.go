...
func (m *ListServiceDashboardClientDeleteEventsExperimentalResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListServiceDashboardClientDeleteEventsExperimentalResponse) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListServiceDashboardClientDeleteEventsExperimentalResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListServiceDashboardClientDeleteEventsExperimentalResponse) UnmarshalBinary(b []byte) error {
	var res ListServiceDashboardClientDeleteEventsExperimentalResponse
