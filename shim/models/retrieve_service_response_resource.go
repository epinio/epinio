...
func (m *RetrieveServiceResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveServiceResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveServiceResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveServiceResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveServiceResponseResource
