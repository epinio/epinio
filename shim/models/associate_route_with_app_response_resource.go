...
func (m *AssociateRouteWithAppResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AssociateRouteWithAppResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponseResource) UnmarshalBinary(b []byte) error {
	var res AssociateRouteWithAppResponseResource
