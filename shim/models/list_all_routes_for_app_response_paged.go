...
func (m *ListAllRoutesForAppResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllRoutesForAppResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllRoutesForAppResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllRoutesForAppResponsePaged
