...
func (m *ListEventsAssociatedWithAppSinceJanuary12014Response) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListEventsAssociatedWithAppSinceJanuary12014Response) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListEventsAssociatedWithAppSinceJanuary12014Response) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListEventsAssociatedWithAppSinceJanuary12014Response) UnmarshalBinary(b []byte) error {
	var res ListEventsAssociatedWithAppSinceJanuary12014Response
