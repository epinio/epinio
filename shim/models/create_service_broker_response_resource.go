...
func (m *CreateServiceBrokerResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateServiceBrokerResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreateServiceBrokerResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreateServiceBrokerResponseResource) UnmarshalBinary(b []byte) error {
	var res CreateServiceBrokerResponseResource
