...
func (m *ListAllPrivateDomainsResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllPrivateDomainsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllPrivateDomainsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllPrivateDomainsResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllPrivateDomainsResponseResource
