...
func (m *ListAllDomainsDeprecatedResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllDomainsDeprecatedResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllDomainsDeprecatedResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllDomainsDeprecatedResponsePaged
