...
func (m *ListAllServiceBindingsResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServiceBindingsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllServiceBindingsResponseResource
