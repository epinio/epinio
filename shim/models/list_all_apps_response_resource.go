...
func (m *ListAllAppsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllAppsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllAppsResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllAppsResponseResource
