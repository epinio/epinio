...
func (m *ListAllAppsForSpaceResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllAppsForSpaceResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllAppsForSpaceResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllAppsForSpaceResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllAppsForSpaceResponseResource
