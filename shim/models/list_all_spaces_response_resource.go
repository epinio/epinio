...
func (m *ListAllSpacesResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllSpacesResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllSpacesResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllSpacesResponseResource
