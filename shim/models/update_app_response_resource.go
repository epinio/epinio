...
func (m *UpdateAppResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateAppResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateAppResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateAppResponseResource
