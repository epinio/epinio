...
func (m *ListAppUpdateEventsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAppUpdateEventsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAppUpdateEventsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAppUpdateEventsResponsePaged
