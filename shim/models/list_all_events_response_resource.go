...
func (m *ListAllEventsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllEventsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllEventsResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllEventsResponseResource
