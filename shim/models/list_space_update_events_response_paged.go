...
func (m *ListSpaceUpdateEventsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListSpaceUpdateEventsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListSpaceUpdateEventsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListSpaceUpdateEventsResponsePaged
