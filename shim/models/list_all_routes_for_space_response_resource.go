...
func (m *ListAllRoutesForSpaceResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllRoutesForSpaceResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllRoutesForSpaceResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllRoutesForSpaceResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllRoutesForSpaceResponseResource
