...
func (m *ListAllAuditorsForSpaceResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllAuditorsForSpaceResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllAuditorsForSpaceResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllAuditorsForSpaceResponsePaged
