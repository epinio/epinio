...
func (m *ListAllBuildpacksResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllBuildpacksResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllBuildpacksResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllBuildpacksResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllBuildpacksResponseResource
