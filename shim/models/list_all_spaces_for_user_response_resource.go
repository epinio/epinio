...
func (m *ListAllSpacesForUserResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllSpacesForUserResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllSpacesForUserResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllSpacesForUserResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllSpacesForUserResponseResource
