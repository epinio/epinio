...
func (m *GetAppSummaryResponse) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAvailableDomains(formats); err != nil {
		res = append(res, err)
	}
...
func (m *GetAppSummaryResponse) validateAvailableDomains(formats strfmt.Registry) error {

	if swag.IsZero(m.AvailableDomains) { // not required
		return nil
	}

	for i := 0; i < len(m.AvailableDomains); i++ {

		if err := m.AvailableDomains[i].Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("available_domains" + "." + strconv.Itoa(i))
			}
			return err
		}
...
func (m *GetAppSummaryResponse) validateBuildpack(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateCommand(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateDebug(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateDetectedBuildpack(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateDockerImage(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateEnvironmentJSON(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateHealthCheckTimeout(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateRoutes(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateServices(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateStagingFailedReason(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponse) validateStagingTaskID(formats strfmt.Registry) error {
