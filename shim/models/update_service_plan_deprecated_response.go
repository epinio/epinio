...
func (m *UpdateServicePlanDeprecatedResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateServicePlanDeprecatedResponse) validateExtra(formats strfmt.Registry) error {
...
func (m *UpdateServicePlanDeprecatedResponse) UnmarshalBinary(b []byte) error {
	var res UpdateServicePlanDeprecatedResponse
