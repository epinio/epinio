...
func (m *CreateServiceBindingResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateServiceBindingResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreateServiceBindingResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreateServiceBindingResponseResource) UnmarshalBinary(b []byte) error {
	var res CreateServiceBindingResponseResource
