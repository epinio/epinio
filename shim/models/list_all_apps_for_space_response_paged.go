...
func (m *ListAllAppsForSpaceResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllAppsForSpaceResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllAppsForSpaceResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllAppsForSpaceResponsePaged
