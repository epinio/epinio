...
func (m *ListAllRoutesForSpaceResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllRoutesForSpaceResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllRoutesForSpaceResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllRoutesForSpaceResponsePaged
