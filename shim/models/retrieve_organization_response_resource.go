...
func (m *RetrieveOrganizationResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveOrganizationResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveOrganizationResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveOrganizationResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveOrganizationResponseResource
