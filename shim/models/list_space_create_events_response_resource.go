...
func (m *ListSpaceCreateEventsResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListSpaceCreateEventsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListSpaceCreateEventsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListSpaceCreateEventsResponseResource) UnmarshalBinary(b []byte) error {
	var res ListSpaceCreateEventsResponseResource
