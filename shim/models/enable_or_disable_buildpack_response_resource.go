...
func (m *EnableOrDisableBuildpackResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EnableOrDisableBuildpackResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *EnableOrDisableBuildpackResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *EnableOrDisableBuildpackResponseResource) UnmarshalBinary(b []byte) error {
	var res EnableOrDisableBuildpackResponseResource
