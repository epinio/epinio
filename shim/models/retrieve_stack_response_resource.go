...
func (m *RetrieveStackResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveStackResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveStackResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveStackResponseResource
