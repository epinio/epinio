...
func (m *ListAppExitedEventsResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAppExitedEventsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAppExitedEventsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAppExitedEventsResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAppExitedEventsResponseResource
