...
func (m *CreateServiceBindingResponse) validateBindingOptions(formats strfmt.Registry) error {
...
func (m *CreateServiceBindingResponse) validateCredentials(formats strfmt.Registry) error {
...
func (m *CreateServiceBindingResponse) validateGatewayData(formats strfmt.Registry) error {
...
func (m *CreateServiceBindingResponse) validateSyslogDrainURL(formats strfmt.Registry) error {
...
func (m *CreateServiceBindingResponse) UnmarshalBinary(b []byte) error {
	var res CreateServiceBindingResponse
