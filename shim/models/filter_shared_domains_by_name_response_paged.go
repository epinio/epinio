...
func (m *FilterSharedDomainsByNameResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FilterSharedDomainsByNameResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *FilterSharedDomainsByNameResponsePaged) UnmarshalBinary(b []byte) error {
	var res FilterSharedDomainsByNameResponsePaged
