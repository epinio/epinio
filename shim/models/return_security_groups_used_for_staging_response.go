...
func (m *ReturnSecurityGroupsUsedForStagingResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnSecurityGroupsUsedForStagingResponse) validateRules(formats strfmt.Registry) error {
...
func (m *ReturnSecurityGroupsUsedForStagingResponse) UnmarshalBinary(b []byte) error {
	var res ReturnSecurityGroupsUsedForStagingResponse
