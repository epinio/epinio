...
func (m *ListAllAuditedSpacesForUserResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllAuditedSpacesForUserResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllAuditedSpacesForUserResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllAuditedSpacesForUserResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllAuditedSpacesForUserResponseResource
