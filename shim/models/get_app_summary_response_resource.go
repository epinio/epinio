...
func (m *GetAppSummaryResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *GetAppSummaryResponseResource) UnmarshalBinary(b []byte) error {
	var res GetAppSummaryResponseResource
