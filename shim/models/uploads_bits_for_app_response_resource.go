...
func (m *UploadsBitsForAppResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UploadsBitsForAppResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UploadsBitsForAppResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UploadsBitsForAppResponseResource) UnmarshalBinary(b []byte) error {
	var res UploadsBitsForAppResponseResource
