...
func (m *FilterPrivateDomainsByNameResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FilterPrivateDomainsByNameResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *FilterPrivateDomainsByNameResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *FilterPrivateDomainsByNameResponseResource) UnmarshalBinary(b []byte) error {
	var res FilterPrivateDomainsByNameResponseResource
