...
func (m *AssociateAppWithRouteResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AssociateAppWithRouteResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *AssociateAppWithRouteResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *AssociateAppWithRouteResponseResource) UnmarshalBinary(b []byte) error {
	var res AssociateAppWithRouteResponseResource
