...
func (m *CreatesDomainOwnedByGivenOrganizationDeprecatedResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CreatesDomainOwnedByGivenOrganizationDeprecatedResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreatesDomainOwnedByGivenOrganizationDeprecatedResponse) UnmarshalBinary(b []byte) error {
	var res CreatesDomainOwnedByGivenOrganizationDeprecatedResponse
