...
func (m *AssociateManagedOrganizationWithUserResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *AssociateManagedOrganizationWithUserResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AssociateManagedOrganizationWithUserResponse) UnmarshalBinary(b []byte) error {
	var res AssociateManagedOrganizationWithUserResponse
