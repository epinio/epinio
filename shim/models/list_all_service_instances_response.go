...
func (m *ListAllServiceInstancesResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServiceInstancesResponse) validateCredentials(formats strfmt.Registry) error {
...
func (m *ListAllServiceInstancesResponse) validateDashboardURL(formats strfmt.Registry) error {
...
func (m *ListAllServiceInstancesResponse) validateGatewayData(formats strfmt.Registry) error {
...
func (m *ListAllServiceInstancesResponse) UnmarshalBinary(b []byte) error {
	var res ListAllServiceInstancesResponse
