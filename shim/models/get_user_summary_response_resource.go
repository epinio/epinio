...
func (m *GetUserSummaryResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *GetUserSummaryResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *GetUserSummaryResponseResource) UnmarshalBinary(b []byte) error {
	var res GetUserSummaryResponseResource
