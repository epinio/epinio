...
func (m *ListAllServicePlansResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServicePlansResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllServicePlansResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllServicePlansResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllServicePlansResponseResource
