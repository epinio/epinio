...
func (m *GetInfoResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *GetInfoResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *GetInfoResponseResource) UnmarshalBinary(b []byte) error {
	var res GetInfoResponseResource
