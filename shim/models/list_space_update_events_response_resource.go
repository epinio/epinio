...
func (m *ListSpaceUpdateEventsResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListSpaceUpdateEventsResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListSpaceUpdateEventsResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListSpaceUpdateEventsResponseResource) UnmarshalBinary(b []byte) error {
	var res ListSpaceUpdateEventsResponseResource
