...
func (m *ListAllMatchingResourcesResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllMatchingResourcesResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllMatchingResourcesResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllMatchingResourcesResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllMatchingResourcesResponseResource
