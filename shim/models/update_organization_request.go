...
func (m *UpdateOrganizationRequest) validateBillingEnabled(formats strfmt.Registry) error {
...
func (m *UpdateOrganizationRequest) validateStatus(formats strfmt.Registry) error {
