...
func (m *ListAllPrivateDomainsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllPrivateDomainsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllPrivateDomainsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllPrivateDomainsResponsePaged
