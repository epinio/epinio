...
func (m *AssociateAuditedOrganizationWithUserResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *AssociateAuditedOrganizationWithUserResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AssociateAuditedOrganizationWithUserResponse) UnmarshalBinary(b []byte) error {
	var res AssociateAuditedOrganizationWithUserResponse
