...
func (m *ListAllStacksResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllStacksResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllStacksResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllStacksResponseResource
