...
func (m *UpdateUserResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateUserResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateUserResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateUserResponseResource
