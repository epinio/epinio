...
func (m *RetrieveDomainDeprecatedResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveDomainDeprecatedResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveDomainDeprecatedResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveDomainDeprecatedResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveDomainDeprecatedResponseResource
