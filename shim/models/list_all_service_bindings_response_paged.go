...
func (m *ListAllServiceBindingsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServiceBindingsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllServiceBindingsResponsePaged
