...
func (m *ListAllAppsForRouteResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllAppsForRouteResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllAppsForRouteResponsePaged
