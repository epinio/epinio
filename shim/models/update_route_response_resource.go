...
func (m *UpdateRouteResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateRouteResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateRouteResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateRouteResponseResource
