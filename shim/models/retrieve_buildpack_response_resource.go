...
func (m *RetrieveBuildpackResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveBuildpackResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveBuildpackResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveBuildpackResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveBuildpackResponseResource
