...
func (m *GetPrivateDomainCreationFeatureFlagResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPrivateDomainCreationFeatureFlagResponse) validateErrorMessage(formats strfmt.Registry) error {
...
func (m *GetPrivateDomainCreationFeatureFlagResponse) UnmarshalBinary(b []byte) error {
	var res GetPrivateDomainCreationFeatureFlagResponse
