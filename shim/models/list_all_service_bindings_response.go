...
func (m *ListAllServiceBindingsResponse) validateBindingOptions(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsResponse) validateCredentials(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsResponse) validateGatewayData(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsResponse) validateSyslogDrainURL(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsResponse) UnmarshalBinary(b []byte) error {
	var res ListAllServiceBindingsResponse
