...
func (m *UpdateServiceInstanceResponse) validateCredentials(formats strfmt.Registry) error {
...
func (m *UpdateServiceInstanceResponse) validateDashboardURL(formats strfmt.Registry) error {
...
func (m *UpdateServiceInstanceResponse) validateGatewayData(formats strfmt.Registry) error {
...
func (m *UpdateServiceInstanceResponse) UnmarshalBinary(b []byte) error {
	var res UpdateServiceInstanceResponse
