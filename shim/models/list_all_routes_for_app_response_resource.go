...
func (m *ListAllRoutesForAppResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllRoutesForAppResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllRoutesForAppResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllRoutesForAppResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllRoutesForAppResponseResource
