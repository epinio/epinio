...
func (m *ListAllServiceBrokersResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServiceBrokersResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllServiceBrokersResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllServiceBrokersResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllServiceBrokersResponseResource
