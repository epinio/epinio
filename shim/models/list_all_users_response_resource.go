...
func (m *ListAllUsersResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllUsersResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllUsersResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllUsersResponseResource
