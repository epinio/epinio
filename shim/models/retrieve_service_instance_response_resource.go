...
func (m *RetrieveServiceInstanceResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveServiceInstanceResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveServiceInstanceResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveServiceInstanceResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveServiceInstanceResponseResource
