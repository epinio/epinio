...
func (m *RemoveRouteFromAppResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RemoveRouteFromAppResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RemoveRouteFromAppResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RemoveRouteFromAppResponseResource) UnmarshalBinary(b []byte) error {
	var res RemoveRouteFromAppResponseResource
