...
func (m *ListAllAppsForRouteResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllAppsForRouteResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllAppsForRouteResponseResource
