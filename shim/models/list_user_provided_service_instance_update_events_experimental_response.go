...
func (m *ListUserProvidedServiceInstanceUpdateEventsExperimentalResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListUserProvidedServiceInstanceUpdateEventsExperimentalResponse) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListUserProvidedServiceInstanceUpdateEventsExperimentalResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListUserProvidedServiceInstanceUpdateEventsExperimentalResponse) UnmarshalBinary(b []byte) error {
	var res ListUserProvidedServiceInstanceUpdateEventsExperimentalResponse
