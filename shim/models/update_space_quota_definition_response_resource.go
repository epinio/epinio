...
func (m *UpdateSpaceQuotaDefinitionResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateSpaceQuotaDefinitionResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateSpaceQuotaDefinitionResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateSpaceQuotaDefinitionResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateSpaceQuotaDefinitionResponseResource
