...
func (m *RetrieveServiceUsageEventResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetrieveServiceUsageEventResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RetrieveServiceUsageEventResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RetrieveServiceUsageEventResponseResource) UnmarshalBinary(b []byte) error {
	var res RetrieveServiceUsageEventResponseResource
