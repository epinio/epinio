...
func (m *ListAllAppsForRouteResponse) validateBuildpack(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) validateCommand(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) validateDebug(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) validateDetectedBuildpack(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) validateDockerImage(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) validateEnvironmentJSON(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) validateHealthCheckTimeout(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) validateStagingFailedReason(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) validateStagingTaskID(formats strfmt.Registry) error {
...
func (m *ListAllAppsForRouteResponse) UnmarshalBinary(b []byte) error {
	var res ListAllAppsForRouteResponse
