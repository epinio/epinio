...
func (m *FilterSharedDomainsByNameResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FilterSharedDomainsByNameResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *FilterSharedDomainsByNameResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *FilterSharedDomainsByNameResponseResource) UnmarshalBinary(b []byte) error {
	var res FilterSharedDomainsByNameResponseResource
