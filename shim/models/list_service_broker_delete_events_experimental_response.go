...
func (m *ListServiceBrokerDeleteEventsExperimentalResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListServiceBrokerDeleteEventsExperimentalResponse) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListServiceBrokerDeleteEventsExperimentalResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListServiceBrokerDeleteEventsExperimentalResponse) UnmarshalBinary(b []byte) error {
	var res ListServiceBrokerDeleteEventsExperimentalResponse
