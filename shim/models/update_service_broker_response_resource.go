...
func (m *UpdateServiceBrokerResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateServiceBrokerResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateServiceBrokerResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateServiceBrokerResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateServiceBrokerResponseResource
