...
func (m *GettingContentsOfStagingEnvironmentVariableGroupResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *GettingContentsOfStagingEnvironmentVariableGroupResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GettingContentsOfStagingEnvironmentVariableGroupResponse) UnmarshalBinary(b []byte) error {
	var res GettingContentsOfStagingEnvironmentVariableGroupResponse
