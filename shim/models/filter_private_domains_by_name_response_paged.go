...
func (m *FilterPrivateDomainsByNameResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FilterPrivateDomainsByNameResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *FilterPrivateDomainsByNameResponsePaged) UnmarshalBinary(b []byte) error {
	var res FilterPrivateDomainsByNameResponsePaged
