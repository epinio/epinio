...
func (m *RemoveBillingManagerFromOrganizationResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *RemoveBillingManagerFromOrganizationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RemoveBillingManagerFromOrganizationResponse) UnmarshalBinary(b []byte) error {
	var res RemoveBillingManagerFromOrganizationResponse
