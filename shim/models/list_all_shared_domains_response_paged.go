...
func (m *ListAllSharedDomainsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllSharedDomainsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllSharedDomainsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllSharedDomainsResponsePaged
