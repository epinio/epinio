...
func (m *ListAllAuditorsForSpaceResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllAuditorsForSpaceResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllAuditorsForSpaceResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllAuditorsForSpaceResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllAuditorsForSpaceResponseResource
