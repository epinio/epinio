...
func (m *ListServiceBrokerCreateEventsExperimentalResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListServiceBrokerCreateEventsExperimentalResponse) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListServiceBrokerCreateEventsExperimentalResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListServiceBrokerCreateEventsExperimentalResponse) UnmarshalBinary(b []byte) error {
	var res ListServiceBrokerCreateEventsExperimentalResponse
