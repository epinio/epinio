...
func (m *ListAllServicesResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServicesResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ListAllServicesResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListAllServicesResponseResource) UnmarshalBinary(b []byte) error {
	var res ListAllServicesResponseResource
