...
func (m *CreateServiceDeprecatedResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateServiceDeprecatedResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreateServiceDeprecatedResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreateServiceDeprecatedResponseResource) UnmarshalBinary(b []byte) error {
	var res CreateServiceDeprecatedResponseResource
