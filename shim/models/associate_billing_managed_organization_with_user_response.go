...
func (m *AssociateBillingManagedOrganizationWithUserResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *AssociateBillingManagedOrganizationWithUserResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AssociateBillingManagedOrganizationWithUserResponse) UnmarshalBinary(b []byte) error {
	var res AssociateBillingManagedOrganizationWithUserResponse
