...
func (m *AssociateRouteWithAppResponse) validateBuildpack(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) validateCommand(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) validateDebug(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) validateDetectedBuildpack(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) validateDockerImage(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) validateEnvironmentJSON(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) validateHealthCheckTimeout(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) validateStagingFailedReason(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) validateStagingTaskID(formats strfmt.Registry) error {
...
func (m *AssociateRouteWithAppResponse) UnmarshalBinary(b []byte) error {
	var res AssociateRouteWithAppResponse
