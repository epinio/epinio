...
func (m *ListServiceDashboardClientCreateEventsExperimentalResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListServiceDashboardClientCreateEventsExperimentalResponse) validateMetadata(formats strfmt.Registry) error {
...
func (m *ListServiceDashboardClientCreateEventsExperimentalResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListServiceDashboardClientCreateEventsExperimentalResponse) UnmarshalBinary(b []byte) error {
	var res ListServiceDashboardClientCreateEventsExperimentalResponse
