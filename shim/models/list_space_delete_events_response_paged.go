...
func (m *ListSpaceDeleteEventsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListSpaceDeleteEventsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListSpaceDeleteEventsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListSpaceDeleteEventsResponsePaged
