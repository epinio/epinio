...
func (m *RemoveAppFromRouteResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RemoveAppFromRouteResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *RemoveAppFromRouteResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *RemoveAppFromRouteResponseResource) UnmarshalBinary(b []byte) error {
	var res RemoveAppFromRouteResponseResource
