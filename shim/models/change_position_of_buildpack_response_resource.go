...
func (m *ChangePositionOfBuildpackResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ChangePositionOfBuildpackResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *ChangePositionOfBuildpackResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *ChangePositionOfBuildpackResponseResource) UnmarshalBinary(b []byte) error {
	var res ChangePositionOfBuildpackResponseResource
