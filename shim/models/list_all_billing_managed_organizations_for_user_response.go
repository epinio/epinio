...
func (m *ListAllBillingManagedOrganizationsForUserResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ListAllBillingManagedOrganizationsForUserResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListAllBillingManagedOrganizationsForUserResponse) UnmarshalBinary(b []byte) error {
	var res ListAllBillingManagedOrganizationsForUserResponse
