...
func (m *ListAllServiceBindingsForAppResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServiceBindingsForAppResponse) validateBindingOptions(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsForAppResponse) validateCredentials(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsForAppResponse) validateGatewayData(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsForAppResponse) validateSyslogDrainURL(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsForAppResponse) UnmarshalBinary(b []byte) error {
	var res ListAllServiceBindingsForAppResponse
