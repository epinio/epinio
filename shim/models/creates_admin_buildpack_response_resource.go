...
func (m *CreatesAdminBuildpackResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreatesAdminBuildpackResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *CreatesAdminBuildpackResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *CreatesAdminBuildpackResponseResource) UnmarshalBinary(b []byte) error {
	var res CreatesAdminBuildpackResponseResource
