...
func (m *CreateDockerAppExperimentalRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateDockerAppExperimentalRequest) validateBuildpack(formats strfmt.Registry) error {
...
func (m *CreateDockerAppExperimentalRequest) validateCommand(formats strfmt.Registry) error {
...
func (m *CreateDockerAppExperimentalRequest) validateDetectedStartCommand(formats strfmt.Registry) error {
...
func (m *CreateDockerAppExperimentalRequest) validateEnvironmentJSON(formats strfmt.Registry) error {
...
func (m *CreateDockerAppExperimentalRequest) validateHealthCheckTimeout(formats strfmt.Registry) error {
...
func (m *CreateDockerAppExperimentalRequest) UnmarshalBinary(b []byte) error {
	var res CreateDockerAppExperimentalRequest
