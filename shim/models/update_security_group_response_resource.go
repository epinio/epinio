...
func (m *UpdateSecurityGroupResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateSecurityGroupResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *UpdateSecurityGroupResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *UpdateSecurityGroupResponseResource) UnmarshalBinary(b []byte) error {
	var res UpdateSecurityGroupResponseResource
