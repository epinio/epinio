...
func (m *ListAllSpaceQuotaDefinitionsResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllSpaceQuotaDefinitionsResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllSpaceQuotaDefinitionsResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllSpaceQuotaDefinitionsResponsePaged
