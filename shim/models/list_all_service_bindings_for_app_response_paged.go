...
func (m *ListAllServiceBindingsForAppResponsePaged) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAllServiceBindingsForAppResponsePaged) validateResources(formats strfmt.Registry) error {
...
func (m *ListAllServiceBindingsForAppResponsePaged) UnmarshalBinary(b []byte) error {
	var res ListAllServiceBindingsForAppResponsePaged
