...
func (m *GetAppBitsUploadFeatureFlagResponseResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAppBitsUploadFeatureFlagResponseResource) validateEntity(formats strfmt.Registry) error {
...
func (m *GetAppBitsUploadFeatureFlagResponseResource) validateMetadata(formats strfmt.Registry) error {
...
func (m *GetAppBitsUploadFeatureFlagResponseResource) UnmarshalBinary(b []byte) error {
	var res GetAppBitsUploadFeatureFlagResponseResource
