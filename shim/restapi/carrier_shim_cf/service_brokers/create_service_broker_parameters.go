...
// NewCreateServiceBrokerParams creates a new CreateServiceBrokerParams object
// no default values defined in spec.
func NewCreateServiceBrokerParams() CreateServiceBrokerParams {

	return CreateServiceBrokerParams{}
}

// CreateServiceBrokerParams contains all the bound params for the create service broker operation
...
func (o *CreateServiceBrokerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateServiceBrokerRequest
