...
// NewDeleteServiceBrokerParams creates a new DeleteServiceBrokerParams object
// no default values defined in spec.
func NewDeleteServiceBrokerParams() DeleteServiceBrokerParams {

	return DeleteServiceBrokerParams{}
}

// DeleteServiceBrokerParams contains all the bound params for the delete service broker operation
...
func (o *DeleteServiceBrokerParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
