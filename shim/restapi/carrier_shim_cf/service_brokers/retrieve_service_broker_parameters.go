...
// NewRetrieveServiceBrokerParams creates a new RetrieveServiceBrokerParams object
// no default values defined in spec.
func NewRetrieveServiceBrokerParams() RetrieveServiceBrokerParams {

	return RetrieveServiceBrokerParams{}
}

// RetrieveServiceBrokerParams contains all the bound params for the retrieve service broker operation
...
func (o *RetrieveServiceBrokerParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
