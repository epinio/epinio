...
// NewCreatePrivateDomainOwnedByGivenOrganizationParams creates a new CreatePrivateDomainOwnedByGivenOrganizationParams object
// no default values defined in spec.
func NewCreatePrivateDomainOwnedByGivenOrganizationParams() CreatePrivateDomainOwnedByGivenOrganizationParams {

	return CreatePrivateDomainOwnedByGivenOrganizationParams{}
}

// CreatePrivateDomainOwnedByGivenOrganizationParams contains all the bound params for the create private domain owned by given organization operation
...
func (o *CreatePrivateDomainOwnedByGivenOrganizationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreatePrivateDomainOwnedByGivenOrganizationRequest
