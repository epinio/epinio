...
func NewFilterPrivateDomainsByNameOK() *FilterPrivateDomainsByNameOK {
	...
	return &FilterPrivateDomainsByNameOK{}
}

// WithPayload adds the payload to the filter private domains by name o k response
func (o *FilterPrivateDomainsByNameOK) WithPayload(payload *models.FilterPrivateDomainsByNameResponsePaged) *FilterPrivateDomainsByNameOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the filter private domains by name o k response
func (o *FilterPrivateDomainsByNameOK) SetPayload(payload *models.FilterPrivateDomainsByNameResponsePaged) {
	o.Payload = payload
}
