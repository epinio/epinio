...
func (o *FilterPrivateDomainsByNameURL) WithBasePath(bp string) *FilterPrivateDomainsByNameURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *FilterPrivateDomainsByNameURL) String() string {
...
func (o *FilterPrivateDomainsByNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on FilterPrivateDomainsByNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on FilterPrivateDomainsByNameURL")
	}
