...
// NewRetrievePrivateDomainParams creates a new RetrievePrivateDomainParams object
// no default values defined in spec.
func NewRetrievePrivateDomainParams() RetrievePrivateDomainParams {

	return RetrievePrivateDomainParams{}
}

// RetrievePrivateDomainParams contains all the bound params for the retrieve private domain operation
...
func (o *RetrievePrivateDomainParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RetrievePrivateDomainParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
