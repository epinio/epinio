...
func (o *DeletePrivateDomainURL) WithBasePath(bp string) *DeletePrivateDomainURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeletePrivateDomainURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on DeletePrivateDomainURL")
	}
...
func (o *DeletePrivateDomainURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeletePrivateDomainURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeletePrivateDomainURL")
	}
