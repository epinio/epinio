...
func (o *RetrievePrivateDomainURL) WithBasePath(bp string) *RetrievePrivateDomainURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RetrievePrivateDomainURL) Build() (*url.URL, error) {
	...
	var _path = "/private_domains/{guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on RetrievePrivateDomainURL")
	}
...
func (o *RetrievePrivateDomainURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrievePrivateDomainURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrievePrivateDomainURL")
	}
