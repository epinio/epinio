...
// NewRetrieveJobThatWasSuccessfulParams creates a new RetrieveJobThatWasSuccessfulParams object
// no default values defined in spec.
func NewRetrieveJobThatWasSuccessfulParams() RetrieveJobThatWasSuccessfulParams {

	return RetrieveJobThatWasSuccessfulParams{}
}

// RetrieveJobThatWasSuccessfulParams contains all the bound params for the retrieve job that was successful operation
...
func (o *RetrieveJobThatWasSuccessfulParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RetrieveJobThatWasSuccessfulParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
