...
func (o *RetrieveDomainDeprecatedURL) WithBasePath(bp string) *RetrieveDomainDeprecatedURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RetrieveDomainDeprecatedURL) Build() (*url.URL, error) {
	...
	var _path = "/domains/{guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on RetrieveDomainDeprecatedURL")
	}
...
func (o *RetrieveDomainDeprecatedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveDomainDeprecatedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveDomainDeprecatedURL")
	}
