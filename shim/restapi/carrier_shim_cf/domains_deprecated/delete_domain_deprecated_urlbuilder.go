...
func (o *DeleteDomainDeprecatedURL) WithBasePath(bp string) *DeleteDomainDeprecatedURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteDomainDeprecatedURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on DeleteDomainDeprecatedURL")
	}
...
func (o *DeleteDomainDeprecatedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteDomainDeprecatedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteDomainDeprecatedURL")
	}
