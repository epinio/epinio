...
func (o *ListAllDomainsDeprecatedURL) WithBasePath(bp string) *ListAllDomainsDeprecatedURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllDomainsDeprecatedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllDomainsDeprecatedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllDomainsDeprecatedURL")
	}
