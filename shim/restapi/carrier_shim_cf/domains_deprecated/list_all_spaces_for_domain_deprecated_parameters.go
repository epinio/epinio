...
// NewListAllSpacesForDomainDeprecatedParams creates a new ListAllSpacesForDomainDeprecatedParams object
// no default values defined in spec.
func NewListAllSpacesForDomainDeprecatedParams() ListAllSpacesForDomainDeprecatedParams {

	return ListAllSpacesForDomainDeprecatedParams{}
}

// ListAllSpacesForDomainDeprecatedParams contains all the bound params for the list all spaces for domain deprecated operation
...
func (o *ListAllSpacesForDomainDeprecatedParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllSpacesForDomainDeprecatedParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
