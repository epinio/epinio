...
// NewDeleteDomainDeprecatedParams creates a new DeleteDomainDeprecatedParams object
// no default values defined in spec.
func NewDeleteDomainDeprecatedParams() DeleteDomainDeprecatedParams {

	return DeleteDomainDeprecatedParams{}
}

// DeleteDomainDeprecatedParams contains all the bound params for the delete domain deprecated operation
...
func (o *DeleteDomainDeprecatedParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteDomainDeprecatedParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
