...
func (o *ReturnSecurityGroupsUsedForRunningAppsURL) Build() (*url.URL, error) {
	...
	var _path = "/config/running_security_groups"
...
func (o *ReturnSecurityGroupsUsedForRunningAppsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReturnSecurityGroupsUsedForRunningAppsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReturnSecurityGroupsUsedForRunningAppsURL")
	}
