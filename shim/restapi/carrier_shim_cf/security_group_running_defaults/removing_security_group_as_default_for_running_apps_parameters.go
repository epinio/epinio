...
// NewRemovingSecurityGroupAsDefaultForRunningAppsParams creates a new RemovingSecurityGroupAsDefaultForRunningAppsParams object
// no default values defined in spec.
func NewRemovingSecurityGroupAsDefaultForRunningAppsParams() RemovingSecurityGroupAsDefaultForRunningAppsParams {

	return RemovingSecurityGroupAsDefaultForRunningAppsParams{}
}

// RemovingSecurityGroupAsDefaultForRunningAppsParams contains all the bound params for the removing security group as default for running apps operation
...
func (o *RemovingSecurityGroupAsDefaultForRunningAppsParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
