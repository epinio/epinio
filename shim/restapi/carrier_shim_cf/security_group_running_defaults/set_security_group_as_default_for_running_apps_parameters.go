...
// NewSetSecurityGroupAsDefaultForRunningAppsParams creates a new SetSecurityGroupAsDefaultForRunningAppsParams object
// no default values defined in spec.
func NewSetSecurityGroupAsDefaultForRunningAppsParams() SetSecurityGroupAsDefaultForRunningAppsParams {

	return SetSecurityGroupAsDefaultForRunningAppsParams{}
}

// SetSecurityGroupAsDefaultForRunningAppsParams contains all the bound params for the set security group as default for running apps operation
...
func (o *SetSecurityGroupAsDefaultForRunningAppsParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
