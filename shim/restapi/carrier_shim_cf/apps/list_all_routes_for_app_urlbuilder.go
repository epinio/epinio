...
func (o *ListAllRoutesForAppURL) WithBasePath(bp string) *ListAllRoutesForAppURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllRoutesForAppURL) Build() (*url.URL, error) {
	...
	var _path = "/apps/{guid}/routes"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllRoutesForAppURL")
	}
...
func (o *ListAllRoutesForAppURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllRoutesForAppURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllRoutesForAppURL")
	}
