...
// NewCopyAppBitsForAppParams creates a new CopyAppBitsForAppParams object
// no default values defined in spec.
func NewCopyAppBitsForAppParams() CopyAppBitsForAppParams {

	return CopyAppBitsForAppParams{}
}

// CopyAppBitsForAppParams contains all the bound params for the copy app bits for app operation
...
func (o *CopyAppBitsForAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CopyAppBitsForAppRequest
...
func (o *CopyAppBitsForAppParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
