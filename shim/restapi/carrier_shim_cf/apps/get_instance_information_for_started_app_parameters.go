...
// NewGetInstanceInformationForStartedAppParams creates a new GetInstanceInformationForStartedAppParams object
// no default values defined in spec.
func NewGetInstanceInformationForStartedAppParams() GetInstanceInformationForStartedAppParams {

	return GetInstanceInformationForStartedAppParams{}
}

// GetInstanceInformationForStartedAppParams contains all the bound params for the get instance information for started app operation
...
func (o *GetInstanceInformationForStartedAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetInstanceInformationForStartedAppParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
