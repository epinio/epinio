...
// NewGetEnvForAppParams creates a new GetEnvForAppParams object
// no default values defined in spec.
func NewGetEnvForAppParams() GetEnvForAppParams {

	return GetEnvForAppParams{}
}

// GetEnvForAppParams contains all the bound params for the get env for app operation
...
func (o *GetEnvForAppParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
