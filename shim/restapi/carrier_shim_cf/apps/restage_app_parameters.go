...
// NewRestageAppParams creates a new RestageAppParams object
// no default values defined in spec.
func NewRestageAppParams() RestageAppParams {

	return RestageAppParams{}
}

// RestageAppParams contains all the bound params for the restage app operation
...
func (o *RestageAppParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
