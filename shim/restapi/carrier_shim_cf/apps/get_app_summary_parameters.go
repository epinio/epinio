...
// NewGetAppSummaryParams creates a new GetAppSummaryParams object
// no default values defined in spec.
func NewGetAppSummaryParams() GetAppSummaryParams {

	return GetAppSummaryParams{}
}

// GetAppSummaryParams contains all the bound params for the get app summary operation
...
func (o *GetAppSummaryParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
