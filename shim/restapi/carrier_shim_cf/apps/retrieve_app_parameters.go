...
// NewRetrieveAppParams creates a new RetrieveAppParams object
// no default values defined in spec.
func NewRetrieveAppParams() RetrieveAppParams {

	return RetrieveAppParams{}
}

// RetrieveAppParams contains all the bound params for the retrieve app operation
...
func (o *RetrieveAppParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
