...
func (o *DownloadsBitsForAppURL) WithBasePath(bp string) *DownloadsBitsForAppURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DownloadsBitsForAppURL) Build() (*url.URL, error) {
	...
	var _path = "/apps/{guid}/download"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on DownloadsBitsForAppURL")
	}
...
func (o *DownloadsBitsForAppURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DownloadsBitsForAppURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DownloadsBitsForAppURL")
	}
