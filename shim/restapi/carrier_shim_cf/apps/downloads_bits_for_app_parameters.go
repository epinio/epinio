...
// NewDownloadsBitsForAppParams creates a new DownloadsBitsForAppParams object
// no default values defined in spec.
func NewDownloadsBitsForAppParams() DownloadsBitsForAppParams {

	return DownloadsBitsForAppParams{}
}

// DownloadsBitsForAppParams contains all the bound params for the downloads bits for app operation
...
func (o *DownloadsBitsForAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DownloadsBitsForAppParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
