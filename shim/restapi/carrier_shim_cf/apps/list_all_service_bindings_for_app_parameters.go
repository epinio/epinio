...
// NewListAllServiceBindingsForAppParams creates a new ListAllServiceBindingsForAppParams object
// no default values defined in spec.
func NewListAllServiceBindingsForAppParams() ListAllServiceBindingsForAppParams {

	return ListAllServiceBindingsForAppParams{}
}

// ListAllServiceBindingsForAppParams contains all the bound params for the list all service bindings for app operation
...
func (o *ListAllServiceBindingsForAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllServiceBindingsForAppParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
