...
func (o *RetrieveAppURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RetrieveAppURL")
	}
...
func (o *RetrieveAppURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveAppURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveAppURL")
	}
