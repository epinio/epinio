...
func (o *RetrieveAppUsageEventURL) WithBasePath(bp string) *RetrieveAppUsageEventURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RetrieveAppUsageEventURL) Build() (*url.URL, error) {
	...
	var _path = "/app_usage_events/{guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on RetrieveAppUsageEventURL")
	}
...
func (o *RetrieveAppUsageEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveAppUsageEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveAppUsageEventURL")
	}
