...
// NewRetrieveAppUsageEventParams creates a new RetrieveAppUsageEventParams object
// no default values defined in spec.
func NewRetrieveAppUsageEventParams() RetrieveAppUsageEventParams {

	return RetrieveAppUsageEventParams{}
}

// RetrieveAppUsageEventParams contains all the bound params for the retrieve app usage event operation
...
func (o *RetrieveAppUsageEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RetrieveAppUsageEventParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
