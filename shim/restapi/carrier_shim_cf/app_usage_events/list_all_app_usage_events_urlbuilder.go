...
func (o *ListAllAppUsageEventsURL) WithBasePath(bp string) *ListAllAppUsageEventsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllAppUsageEventsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllAppUsageEventsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllAppUsageEventsURL")
	}
