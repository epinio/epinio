...
func (o *CreateServiceDeprecatedURL) WithBasePath(bp string) *CreateServiceDeprecatedURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateServiceDeprecatedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateServiceDeprecatedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateServiceDeprecatedURL")
	}
