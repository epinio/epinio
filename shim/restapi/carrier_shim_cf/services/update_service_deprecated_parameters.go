...
// NewUpdateServiceDeprecatedParams creates a new UpdateServiceDeprecatedParams object
// no default values defined in spec.
func NewUpdateServiceDeprecatedParams() UpdateServiceDeprecatedParams {

	return UpdateServiceDeprecatedParams{}
}

// UpdateServiceDeprecatedParams contains all the bound params for the update service deprecated operation
...
func (o *UpdateServiceDeprecatedParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateServiceDeprecatedRequest
