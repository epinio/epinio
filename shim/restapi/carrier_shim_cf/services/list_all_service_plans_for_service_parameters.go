...
// NewListAllServicePlansForServiceParams creates a new ListAllServicePlansForServiceParams object
// no default values defined in spec.
func NewListAllServicePlansForServiceParams() ListAllServicePlansForServiceParams {

	return ListAllServicePlansForServiceParams{}
}

// ListAllServicePlansForServiceParams contains all the bound params for the list all service plans for service operation
...
func (o *ListAllServicePlansForServiceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllServicePlansForServiceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
