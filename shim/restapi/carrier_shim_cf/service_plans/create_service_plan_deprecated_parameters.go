...
// NewCreateServicePlanDeprecatedParams creates a new CreateServicePlanDeprecatedParams object
// no default values defined in spec.
func NewCreateServicePlanDeprecatedParams() CreateServicePlanDeprecatedParams {

	return CreateServicePlanDeprecatedParams{}
}

// CreateServicePlanDeprecatedParams contains all the bound params for the create service plan deprecated operation
...
func (o *CreateServicePlanDeprecatedParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateServicePlanDeprecatedRequest
