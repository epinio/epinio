...
func (o *RetrieveServicePlanURL) WithBasePath(bp string) *RetrieveServicePlanURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RetrieveServicePlanURL) Build() (*url.URL, error) {
	...
	var _path = "/service_plans/{guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on RetrieveServicePlanURL")
	}
...
func (o *RetrieveServicePlanURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveServicePlanURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveServicePlanURL")
	}
