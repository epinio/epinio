...
func (o *CreateServicePlanDeprecatedURL) WithBasePath(bp string) *CreateServicePlanDeprecatedURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateServicePlanDeprecatedURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/service_plans"
...
func (o *CreateServicePlanDeprecatedURL) String() string {
...
func (o *CreateServicePlanDeprecatedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateServicePlanDeprecatedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateServicePlanDeprecatedURL")
	}
