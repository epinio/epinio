...
func (o *ListAllServicePlansURL) WithBasePath(bp string) *ListAllServicePlansURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllServicePlansURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllServicePlansURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllServicePlansURL")
	}
