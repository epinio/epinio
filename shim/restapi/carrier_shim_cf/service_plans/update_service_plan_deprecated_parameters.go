...
// NewUpdateServicePlanDeprecatedParams creates a new UpdateServicePlanDeprecatedParams object
// no default values defined in spec.
func NewUpdateServicePlanDeprecatedParams() UpdateServicePlanDeprecatedParams {

	return UpdateServicePlanDeprecatedParams{}
}

// UpdateServicePlanDeprecatedParams contains all the bound params for the update service plan deprecated operation
...
func (o *UpdateServicePlanDeprecatedParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateServicePlanDeprecatedRequest
