...
func (o *UpdateServicePlanDeprecatedURL) WithBasePath(bp string) *UpdateServicePlanDeprecatedURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateServicePlanDeprecatedURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *UpdateServicePlanDeprecatedURL) String() string {
...
func (o *UpdateServicePlanDeprecatedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateServicePlanDeprecatedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateServicePlanDeprecatedURL")
	}
