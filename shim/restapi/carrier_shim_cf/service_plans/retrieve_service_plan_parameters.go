...
// NewRetrieveServicePlanParams creates a new RetrieveServicePlanParams object
// no default values defined in spec.
func NewRetrieveServicePlanParams() RetrieveServicePlanParams {

	return RetrieveServicePlanParams{}
}

// RetrieveServicePlanParams contains all the bound params for the retrieve service plan operation
...
func (o *RetrieveServicePlanParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RetrieveServicePlanParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
