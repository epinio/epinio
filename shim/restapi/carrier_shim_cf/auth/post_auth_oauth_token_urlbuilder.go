...
func (o *PostAuthOauthTokenURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostAuthOauthTokenURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostAuthOauthTokenURL")
	}
