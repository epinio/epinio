...
// NewRetrieveServiceUsageEventParams creates a new RetrieveServiceUsageEventParams object
// no default values defined in spec.
func NewRetrieveServiceUsageEventParams() RetrieveServiceUsageEventParams {

	return RetrieveServiceUsageEventParams{}
}

// RetrieveServiceUsageEventParams contains all the bound params for the retrieve service usage event operation
...
func (o *RetrieveServiceUsageEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RetrieveServiceUsageEventParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
