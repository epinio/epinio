...
func (o *RetrieveServiceUsageEventURL) WithBasePath(bp string) *RetrieveServiceUsageEventURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RetrieveServiceUsageEventURL) Build() (*url.URL, error) {
	...
	var _path = "/service_usage_events/{guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on RetrieveServiceUsageEventURL")
	}
...
func (o *RetrieveServiceUsageEventURL) String() string {
...
func (o *RetrieveServiceUsageEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveServiceUsageEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveServiceUsageEventURL")
	}
