...
func (o *ListServiceUsageEventsURL) WithBasePath(bp string) *ListServiceUsageEventsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListServiceUsageEventsURL) Build() (*url.URL, error) {
	...
	var _path = "/service_usage_events"
...
func (o *ListServiceUsageEventsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListServiceUsageEventsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListServiceUsageEventsURL")
	}
