...
func (o *DeleteServiceAuthTokenDeprecatedURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on DeleteServiceAuthTokenDeprecatedURL")
	}
...
func (o *DeleteServiceAuthTokenDeprecatedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteServiceAuthTokenDeprecatedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteServiceAuthTokenDeprecatedURL")
	}
