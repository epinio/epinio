...
// NewRetrieveServiceAuthTokenDeprecatedParams creates a new RetrieveServiceAuthTokenDeprecatedParams object
// no default values defined in spec.
func NewRetrieveServiceAuthTokenDeprecatedParams() RetrieveServiceAuthTokenDeprecatedParams {

	return RetrieveServiceAuthTokenDeprecatedParams{}
}

// RetrieveServiceAuthTokenDeprecatedParams contains all the bound params for the retrieve service auth token deprecated operation
...
func (o *RetrieveServiceAuthTokenDeprecatedParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
