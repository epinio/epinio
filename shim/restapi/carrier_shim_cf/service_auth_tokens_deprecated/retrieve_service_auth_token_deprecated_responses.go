...
type RetrieveServiceAuthTokenDeprecatedOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.RetrieveServiceAuthTokenDeprecatedResponse `json:"body,omitempty"`
}
...
func (o *RetrieveServiceAuthTokenDeprecatedOK) WithPayload(payload *models.RetrieveServiceAuthTokenDeprecatedResponse) *RetrieveServiceAuthTokenDeprecatedOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the retrieve service auth token deprecated o k response
func (o *RetrieveServiceAuthTokenDeprecatedOK) SetPayload(payload *models.RetrieveServiceAuthTokenDeprecatedResponse) {
	o.Payload = payload
}
