...
// NewDeleteServiceAuthTokenDeprecatedParams creates a new DeleteServiceAuthTokenDeprecatedParams object
// no default values defined in spec.
func NewDeleteServiceAuthTokenDeprecatedParams() DeleteServiceAuthTokenDeprecatedParams {

	return DeleteServiceAuthTokenDeprecatedParams{}
}

// DeleteServiceAuthTokenDeprecatedParams contains all the bound params for the delete service auth token deprecated operation
...
func (o *DeleteServiceAuthTokenDeprecatedParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
