...
// NewUpdateOrganizationQuotaDefinitionParams creates a new UpdateOrganizationQuotaDefinitionParams object
// no default values defined in spec.
func NewUpdateOrganizationQuotaDefinitionParams() UpdateOrganizationQuotaDefinitionParams {

	return UpdateOrganizationQuotaDefinitionParams{}
}

// UpdateOrganizationQuotaDefinitionParams contains all the bound params for the update organization quota definition operation
...
func (o *UpdateOrganizationQuotaDefinitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateOrganizationQuotaDefinitionRequest
...
func (o *UpdateOrganizationQuotaDefinitionParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
