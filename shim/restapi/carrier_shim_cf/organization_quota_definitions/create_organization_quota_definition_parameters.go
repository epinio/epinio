...
// NewCreateOrganizationQuotaDefinitionParams creates a new CreateOrganizationQuotaDefinitionParams object
// no default values defined in spec.
func NewCreateOrganizationQuotaDefinitionParams() CreateOrganizationQuotaDefinitionParams {

	return CreateOrganizationQuotaDefinitionParams{}
}

// CreateOrganizationQuotaDefinitionParams contains all the bound params for the create organization quota definition operation
...
func (o *CreateOrganizationQuotaDefinitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateOrganizationQuotaDefinitionRequest
