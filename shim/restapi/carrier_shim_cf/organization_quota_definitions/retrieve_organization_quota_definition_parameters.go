...
// NewRetrieveOrganizationQuotaDefinitionParams creates a new RetrieveOrganizationQuotaDefinitionParams object
// no default values defined in spec.
func NewRetrieveOrganizationQuotaDefinitionParams() RetrieveOrganizationQuotaDefinitionParams {

	return RetrieveOrganizationQuotaDefinitionParams{}
}

// RetrieveOrganizationQuotaDefinitionParams contains all the bound params for the retrieve organization quota definition operation
...
func (o *RetrieveOrganizationQuotaDefinitionParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
