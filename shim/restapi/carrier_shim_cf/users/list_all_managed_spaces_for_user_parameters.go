...
// NewListAllManagedSpacesForUserParams creates a new ListAllManagedSpacesForUserParams object
// no default values defined in spec.
func NewListAllManagedSpacesForUserParams() ListAllManagedSpacesForUserParams {

	return ListAllManagedSpacesForUserParams{}
}

// ListAllManagedSpacesForUserParams contains all the bound params for the list all managed spaces for user operation
...
func (o *ListAllManagedSpacesForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllManagedSpacesForUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
