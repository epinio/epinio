...
func (o *RemoveManagedSpaceFromUserURL) WithBasePath(bp string) *RemoveManagedSpaceFromUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RemoveManagedSpaceFromUserURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveManagedSpaceFromUserURL")
	}
	...
	if managedSpaceGUID != "" {
		...
		return nil, errors.New("managedSpaceGuid is required on RemoveManagedSpaceFromUserURL")
	}
...
func (o *RemoveManagedSpaceFromUserURL) String() string {
...
func (o *RemoveManagedSpaceFromUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveManagedSpaceFromUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveManagedSpaceFromUserURL")
	}
