...
// NewListAllBillingManagedOrganizationsForUserParams creates a new ListAllBillingManagedOrganizationsForUserParams object
// no default values defined in spec.
func NewListAllBillingManagedOrganizationsForUserParams() ListAllBillingManagedOrganizationsForUserParams {

	return ListAllBillingManagedOrganizationsForUserParams{}
}

// ListAllBillingManagedOrganizationsForUserParams contains all the bound params for the list all billing managed organizations for user operation
...
func (o *ListAllBillingManagedOrganizationsForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllBillingManagedOrganizationsForUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
