...
func (o *RemoveManagedSpaceFromUserCreated) WithPayload(payload *models.RemoveManagedSpaceFromUserResponseResource) *RemoveManagedSpaceFromUserCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the remove managed space from user created response
func (o *RemoveManagedSpaceFromUserCreated) SetPayload(payload *models.RemoveManagedSpaceFromUserResponseResource) {
	o.Payload = payload
}
