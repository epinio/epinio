...
// NewRemoveOrganizationFromUserParams creates a new RemoveOrganizationFromUserParams object
// no default values defined in spec.
func NewRemoveOrganizationFromUserParams() RemoveOrganizationFromUserParams {

	return RemoveOrganizationFromUserParams{}
}

// RemoveOrganizationFromUserParams contains all the bound params for the remove organization from user operation
...
func (o *RemoveOrganizationFromUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RemoveOrganizationFromUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RemoveOrganizationFromUserParams) bindOrganizationGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
