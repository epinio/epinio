...
// NewListAllManagedOrganizationsForUserParams creates a new ListAllManagedOrganizationsForUserParams object
// no default values defined in spec.
func NewListAllManagedOrganizationsForUserParams() ListAllManagedOrganizationsForUserParams {

	return ListAllManagedOrganizationsForUserParams{}
}

// ListAllManagedOrganizationsForUserParams contains all the bound params for the list all managed organizations for user operation
...
func (o *ListAllManagedOrganizationsForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllManagedOrganizationsForUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
