...
// NewGetUserSummaryParams creates a new GetUserSummaryParams object
// no default values defined in spec.
func NewGetUserSummaryParams() GetUserSummaryParams {

	return GetUserSummaryParams{}
}

// GetUserSummaryParams contains all the bound params for the get user summary operation
...
func (o *GetUserSummaryParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
