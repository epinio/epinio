...
// NewListAllSpacesForUserParams creates a new ListAllSpacesForUserParams object
// no default values defined in spec.
func NewListAllSpacesForUserParams() ListAllSpacesForUserParams {

	return ListAllSpacesForUserParams{}
}

// ListAllSpacesForUserParams contains all the bound params for the list all spaces for user operation
...
func (o *ListAllSpacesForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllSpacesForUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
