...
func (o *AssociateSpaceWithUserURL) WithBasePath(bp string) *AssociateSpaceWithUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *AssociateSpaceWithUserURL) Build() (*url.URL, error) {
	...
	var _path = "/users/{guid}/spaces/{space_guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on AssociateSpaceWithUserURL")
	}
	...
	if spaceGUID != "" {
		...
		return nil, errors.New("spaceGuid is required on AssociateSpaceWithUserURL")
	}
...
func (o *AssociateSpaceWithUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AssociateSpaceWithUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AssociateSpaceWithUserURL")
	}
