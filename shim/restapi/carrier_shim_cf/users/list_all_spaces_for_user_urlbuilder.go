...
func (o *ListAllSpacesForUserURL) WithBasePath(bp string) *ListAllSpacesForUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllSpacesForUserURL) Build() (*url.URL, error) {
	...
	var _path = "/users/{guid}/spaces"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllSpacesForUserURL")
	}
...
func (o *ListAllSpacesForUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllSpacesForUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllSpacesForUserURL")
	}
