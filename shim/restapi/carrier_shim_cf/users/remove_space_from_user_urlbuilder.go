...
func (o *RemoveSpaceFromUserURL) WithBasePath(bp string) *RemoveSpaceFromUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RemoveSpaceFromUserURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveSpaceFromUserURL")
	}
	...
	if spaceGUID != "" {
		...
		return nil, errors.New("spaceGuid is required on RemoveSpaceFromUserURL")
	}
...
func (o *RemoveSpaceFromUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveSpaceFromUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveSpaceFromUserURL")
	}
