...
// RetrieveUserParams contains all the bound params for the retrieve user operation
...
func (o *RetrieveUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
