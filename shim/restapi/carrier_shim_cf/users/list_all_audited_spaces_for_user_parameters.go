...
// NewListAllAuditedSpacesForUserParams creates a new ListAllAuditedSpacesForUserParams object
// no default values defined in spec.
func NewListAllAuditedSpacesForUserParams() ListAllAuditedSpacesForUserParams {

	return ListAllAuditedSpacesForUserParams{}
}

// ListAllAuditedSpacesForUserParams contains all the bound params for the list all audited spaces for user operation
...
func (o *ListAllAuditedSpacesForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllAuditedSpacesForUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
