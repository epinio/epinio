...
// NewAssociateAuditedSpaceWithUserParams creates a new AssociateAuditedSpaceWithUserParams object
// no default values defined in spec.
func NewAssociateAuditedSpaceWithUserParams() AssociateAuditedSpaceWithUserParams {

	return AssociateAuditedSpaceWithUserParams{}
}

// AssociateAuditedSpaceWithUserParams contains all the bound params for the associate audited space with user operation
...
func (o *AssociateAuditedSpaceWithUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AssociateAuditedSpaceWithUserParams) bindAuditedSpaceGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AssociateAuditedSpaceWithUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
