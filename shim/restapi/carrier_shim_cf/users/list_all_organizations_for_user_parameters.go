...
// NewListAllOrganizationsForUserParams creates a new ListAllOrganizationsForUserParams object
// no default values defined in spec.
func NewListAllOrganizationsForUserParams() ListAllOrganizationsForUserParams {

	return ListAllOrganizationsForUserParams{}
}

// ListAllOrganizationsForUserParams contains all the bound params for the list all organizations for user operation
...
func (o *ListAllOrganizationsForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllOrganizationsForUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
