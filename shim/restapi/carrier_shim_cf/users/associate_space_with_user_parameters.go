...
// NewAssociateSpaceWithUserParams creates a new AssociateSpaceWithUserParams object
// no default values defined in spec.
func NewAssociateSpaceWithUserParams() AssociateSpaceWithUserParams {

	return AssociateSpaceWithUserParams{}
}

// AssociateSpaceWithUserParams contains all the bound params for the associate space with user operation
...
func (o *AssociateSpaceWithUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AssociateSpaceWithUserParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AssociateSpaceWithUserParams) bindSpaceGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
