...
func (o *DeleteStackURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on DeleteStackURL")
	}
...
func (o *DeleteStackURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteStackURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteStackURL")
	}
