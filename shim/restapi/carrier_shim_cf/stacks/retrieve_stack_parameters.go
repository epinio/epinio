...
// NewRetrieveStackParams creates a new RetrieveStackParams object
// no default values defined in spec.
func NewRetrieveStackParams() RetrieveStackParams {

	return RetrieveStackParams{}
}

// RetrieveStackParams contains all the bound params for the retrieve stack operation
...
func (o *RetrieveStackParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
