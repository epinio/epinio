...
func (o *CreatesAdminBuildpackURL) WithBasePath(bp string) *CreatesAdminBuildpackURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreatesAdminBuildpackURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreatesAdminBuildpackURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreatesAdminBuildpackURL")
	}
