...
// NewDeleteBuildpackParams creates a new DeleteBuildpackParams object
// no default values defined in spec.
func NewDeleteBuildpackParams() DeleteBuildpackParams {

	return DeleteBuildpackParams{}
}

// DeleteBuildpackParams contains all the bound params for the delete buildpack operation
...
func (o *DeleteBuildpackParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
