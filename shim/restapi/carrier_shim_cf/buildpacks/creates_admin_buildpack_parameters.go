...
// NewCreatesAdminBuildpackParams creates a new CreatesAdminBuildpackParams object
// no default values defined in spec.
func NewCreatesAdminBuildpackParams() CreatesAdminBuildpackParams {

	return CreatesAdminBuildpackParams{}
}

// CreatesAdminBuildpackParams contains all the bound params for the creates admin buildpack operation
...
func (o *CreatesAdminBuildpackParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreatesAdminBuildpackRequest
