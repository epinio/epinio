...
func (o *LockOrUnlockBuildpackURL) WithBasePath(bp string) *LockOrUnlockBuildpackURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *LockOrUnlockBuildpackURL) Build() (*url.URL, error) {
	...
	var _path = "/buildpacks/{guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on LockOrUnlockBuildpackURL")
	}
...
func (o *LockOrUnlockBuildpackURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on LockOrUnlockBuildpackURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on LockOrUnlockBuildpackURL")
	}
