...
func (o *ListAllManagersForSpaceURL) WithBasePath(bp string) *ListAllManagersForSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllManagersForSpaceURL) Build() (*url.URL, error) {
	...
	var _path = "/spaces/{guid}/managers"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllManagersForSpaceURL")
	}
...
func (o *ListAllManagersForSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllManagersForSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllManagersForSpaceURL")
	}
