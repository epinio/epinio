...
func (o *RemoveManagerFromSpaceURL) WithBasePath(bp string) *RemoveManagerFromSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RemoveManagerFromSpaceURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveManagerFromSpaceURL")
	}
	...
	if managerGUID != "" {
		...
		return nil, errors.New("managerGuid is required on RemoveManagerFromSpaceURL")
	}
...
func (o *RemoveManagerFromSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveManagerFromSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveManagerFromSpaceURL")
	}
