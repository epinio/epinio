...
// NewListAllRoutesForSpaceParams creates a new ListAllRoutesForSpaceParams object
// no default values defined in spec.
func NewListAllRoutesForSpaceParams() ListAllRoutesForSpaceParams {

	return ListAllRoutesForSpaceParams{}
}

// ListAllRoutesForSpaceParams contains all the bound params for the list all routes for space operation
...
func (o *ListAllRoutesForSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllRoutesForSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
