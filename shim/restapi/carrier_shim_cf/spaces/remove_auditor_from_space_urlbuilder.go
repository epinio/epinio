...
func (o *RemoveAuditorFromSpaceURL) WithBasePath(bp string) *RemoveAuditorFromSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RemoveAuditorFromSpaceURL) Build() (*url.URL, error) {
	...
	if auditorGUID != "" {
		...
		return nil, errors.New("auditorGuid is required on RemoveAuditorFromSpaceURL")
	}
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveAuditorFromSpaceURL")
	}
...
func (o *RemoveAuditorFromSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveAuditorFromSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveAuditorFromSpaceURL")
	}
