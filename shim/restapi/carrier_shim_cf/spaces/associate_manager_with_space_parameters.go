...
// NewAssociateManagerWithSpaceParams creates a new AssociateManagerWithSpaceParams object
// no default values defined in spec.
func NewAssociateManagerWithSpaceParams() AssociateManagerWithSpaceParams {

	return AssociateManagerWithSpaceParams{}
}

// AssociateManagerWithSpaceParams contains all the bound params for the associate manager with space operation
...
func (o *AssociateManagerWithSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AssociateManagerWithSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AssociateManagerWithSpaceParams) bindManagerGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
