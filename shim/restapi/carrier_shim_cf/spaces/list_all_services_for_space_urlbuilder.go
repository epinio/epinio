...
func (o *ListAllServicesForSpaceURL) WithBasePath(bp string) *ListAllServicesForSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllServicesForSpaceURL) Build() (*url.URL, error) {
	...
	var _path = "/spaces/{guid}/services"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllServicesForSpaceURL")
	}
...
func (o *ListAllServicesForSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllServicesForSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllServicesForSpaceURL")
	}
