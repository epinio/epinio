...
func (o *ListAllAppsForSpaceURL) WithBasePath(bp string) *ListAllAppsForSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllAppsForSpaceURL) Build() (*url.URL, error) {
	...
	var _path = "/spaces/{guid}/apps"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllAppsForSpaceURL")
	}
...
func (o *ListAllAppsForSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllAppsForSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllAppsForSpaceURL")
	}
