...
func (o *ListAllDevelopersForSpaceURL) WithBasePath(bp string) *ListAllDevelopersForSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllDevelopersForSpaceURL) Build() (*url.URL, error) {
	...
	var _path = "/spaces/{guid}/developers"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllDevelopersForSpaceURL")
	}
...
func (o *ListAllDevelopersForSpaceURL) String() string {
...
func (o *ListAllDevelopersForSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllDevelopersForSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllDevelopersForSpaceURL")
	}
