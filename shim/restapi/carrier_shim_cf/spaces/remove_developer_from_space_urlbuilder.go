...
func (o *RemoveDeveloperFromSpaceURL) WithBasePath(bp string) *RemoveDeveloperFromSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RemoveDeveloperFromSpaceURL) Build() (*url.URL, error) {
	...
	if developerGUID != "" {
		...
		return nil, errors.New("developerGuid is required on RemoveDeveloperFromSpaceURL")
	}
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveDeveloperFromSpaceURL")
	}
...
func (o *RemoveDeveloperFromSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveDeveloperFromSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveDeveloperFromSpaceURL")
	}
