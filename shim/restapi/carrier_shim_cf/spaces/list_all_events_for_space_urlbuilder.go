...
func (o *ListAllEventsForSpaceURL) WithBasePath(bp string) *ListAllEventsForSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllEventsForSpaceURL) Build() (*url.URL, error) {
	...
	var _path = "/spaces/{guid}/events"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllEventsForSpaceURL")
	}
...
func (o *ListAllEventsForSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllEventsForSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllEventsForSpaceURL")
	}
