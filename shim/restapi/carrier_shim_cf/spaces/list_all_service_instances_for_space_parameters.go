...
// NewListAllServiceInstancesForSpaceParams creates a new ListAllServiceInstancesForSpaceParams object
// no default values defined in spec.
func NewListAllServiceInstancesForSpaceParams() ListAllServiceInstancesForSpaceParams {

	return ListAllServiceInstancesForSpaceParams{}
}

// ListAllServiceInstancesForSpaceParams contains all the bound params for the list all service instances for space operation
...
func (o *ListAllServiceInstancesForSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllServiceInstancesForSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
