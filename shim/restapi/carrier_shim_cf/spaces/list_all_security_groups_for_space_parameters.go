...
// NewListAllSecurityGroupsForSpaceParams creates a new ListAllSecurityGroupsForSpaceParams object
// no default values defined in spec.
func NewListAllSecurityGroupsForSpaceParams() ListAllSecurityGroupsForSpaceParams {

	return ListAllSecurityGroupsForSpaceParams{}
}

// ListAllSecurityGroupsForSpaceParams contains all the bound params for the list all security groups for space operation
...
func (o *ListAllSecurityGroupsForSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllSecurityGroupsForSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
