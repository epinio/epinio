...
// NewListAllAuditorsForSpaceParams creates a new ListAllAuditorsForSpaceParams object
// no default values defined in spec.
func NewListAllAuditorsForSpaceParams() ListAllAuditorsForSpaceParams {

	return ListAllAuditorsForSpaceParams{}
}

// ListAllAuditorsForSpaceParams contains all the bound params for the list all auditors for space operation
...
func (o *ListAllAuditorsForSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllAuditorsForSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
