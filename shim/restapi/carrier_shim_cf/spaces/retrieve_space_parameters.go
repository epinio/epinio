...
// NewRetrieveSpaceParams creates a new RetrieveSpaceParams object
// no default values defined in spec.
func NewRetrieveSpaceParams() RetrieveSpaceParams {

	return RetrieveSpaceParams{}
}

// RetrieveSpaceParams contains all the bound params for the retrieve space operation
...
func (o *RetrieveSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
