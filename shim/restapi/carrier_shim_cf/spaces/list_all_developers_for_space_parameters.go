...
// NewListAllDevelopersForSpaceParams creates a new ListAllDevelopersForSpaceParams object
// no default values defined in spec.
func NewListAllDevelopersForSpaceParams() ListAllDevelopersForSpaceParams {

	return ListAllDevelopersForSpaceParams{}
}

// ListAllDevelopersForSpaceParams contains all the bound params for the list all developers for space operation
...
func (o *ListAllDevelopersForSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllDevelopersForSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
