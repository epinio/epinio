...
// DeleteSpaceParams contains all the bound params for the delete space operation
...
func (o *DeleteSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
