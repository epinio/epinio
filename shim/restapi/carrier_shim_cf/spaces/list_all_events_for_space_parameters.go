...
// NewListAllEventsForSpaceParams creates a new ListAllEventsForSpaceParams object
// no default values defined in spec.
func NewListAllEventsForSpaceParams() ListAllEventsForSpaceParams {

	return ListAllEventsForSpaceParams{}
}

// ListAllEventsForSpaceParams contains all the bound params for the list all events for space operation
...
func (o *ListAllEventsForSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllEventsForSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
