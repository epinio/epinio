...
func (o *ListAllAuditorsForSpaceURL) WithBasePath(bp string) *ListAllAuditorsForSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllAuditorsForSpaceURL) Build() (*url.URL, error) {
	...
	var _path = "/spaces/{guid}/auditors"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllAuditorsForSpaceURL")
	}
...
func (o *ListAllAuditorsForSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllAuditorsForSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllAuditorsForSpaceURL")
	}
