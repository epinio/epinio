...
// NewListAllAppsForSpaceParams creates a new ListAllAppsForSpaceParams object
// no default values defined in spec.
func NewListAllAppsForSpaceParams() ListAllAppsForSpaceParams {

	return ListAllAppsForSpaceParams{}
}

// ListAllAppsForSpaceParams contains all the bound params for the list all apps for space operation
...
func (o *ListAllAppsForSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllAppsForSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
