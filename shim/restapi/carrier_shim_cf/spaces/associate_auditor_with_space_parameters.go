...
// NewAssociateAuditorWithSpaceParams creates a new AssociateAuditorWithSpaceParams object
// no default values defined in spec.
func NewAssociateAuditorWithSpaceParams() AssociateAuditorWithSpaceParams {

	return AssociateAuditorWithSpaceParams{}
}

// AssociateAuditorWithSpaceParams contains all the bound params for the associate auditor with space operation
...
func (o *AssociateAuditorWithSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AssociateAuditorWithSpaceParams) bindAuditorGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AssociateAuditorWithSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
