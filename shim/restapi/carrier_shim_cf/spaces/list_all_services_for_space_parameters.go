...
// NewListAllServicesForSpaceParams creates a new ListAllServicesForSpaceParams object
// no default values defined in spec.
func NewListAllServicesForSpaceParams() ListAllServicesForSpaceParams {

	return ListAllServicesForSpaceParams{}
}

// ListAllServicesForSpaceParams contains all the bound params for the list all services for space operation
...
func (o *ListAllServicesForSpaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllServicesForSpaceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
