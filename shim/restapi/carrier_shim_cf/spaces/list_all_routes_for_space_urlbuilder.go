...
func (o *ListAllRoutesForSpaceURL) WithBasePath(bp string) *ListAllRoutesForSpaceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllRoutesForSpaceURL) Build() (*url.URL, error) {
	...
	var _path = "/spaces/{guid}/routes"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllRoutesForSpaceURL")
	}
...
func (o *ListAllRoutesForSpaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllRoutesForSpaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllRoutesForSpaceURL")
	}
