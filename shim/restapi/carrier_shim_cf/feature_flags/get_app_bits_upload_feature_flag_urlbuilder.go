...
func (o *GetAppBitsUploadFeatureFlagURL) WithBasePath(bp string) *GetAppBitsUploadFeatureFlagURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAppBitsUploadFeatureFlagURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/config/feature_flags/app_bits_upload"
...
func (o *GetAppBitsUploadFeatureFlagURL) String() string {
...
func (o *GetAppBitsUploadFeatureFlagURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAppBitsUploadFeatureFlagURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAppBitsUploadFeatureFlagURL")
	}
