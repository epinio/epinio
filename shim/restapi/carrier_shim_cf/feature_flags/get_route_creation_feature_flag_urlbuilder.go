...
func (o *GetRouteCreationFeatureFlagURL) WithBasePath(bp string) *GetRouteCreationFeatureFlagURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRouteCreationFeatureFlagURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/config/feature_flags/route_creation"
...
func (o *GetRouteCreationFeatureFlagURL) String() string {
...
func (o *GetRouteCreationFeatureFlagURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRouteCreationFeatureFlagURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRouteCreationFeatureFlagURL")
	}
