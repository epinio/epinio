...
func (o *GetAppScalingFeatureFlagURL) WithBasePath(bp string) *GetAppScalingFeatureFlagURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAppScalingFeatureFlagURL) Build() (*url.URL, error) {
	...
	var _path = "/config/feature_flags/app_scaling"
...
func (o *GetAppScalingFeatureFlagURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAppScalingFeatureFlagURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAppScalingFeatureFlagURL")
	}
