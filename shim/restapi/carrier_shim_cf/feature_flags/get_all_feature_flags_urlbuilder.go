...
func (o *GetAllFeatureFlagsURL) Build() (*url.URL, error) {
	...
	var _path = "/config/feature_flags"
...
func (o *GetAllFeatureFlagsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAllFeatureFlagsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAllFeatureFlagsURL")
	}
