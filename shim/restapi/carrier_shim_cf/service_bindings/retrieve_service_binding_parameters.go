...
// NewRetrieveServiceBindingParams creates a new RetrieveServiceBindingParams object
// no default values defined in spec.
func NewRetrieveServiceBindingParams() RetrieveServiceBindingParams {

	return RetrieveServiceBindingParams{}
}

// RetrieveServiceBindingParams contains all the bound params for the retrieve service binding operation
...
func (o *RetrieveServiceBindingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RetrieveServiceBindingParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
