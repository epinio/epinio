...
func (o *DeleteServiceBindingURL) WithBasePath(bp string) *DeleteServiceBindingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteServiceBindingURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on DeleteServiceBindingURL")
	}
...
func (o *DeleteServiceBindingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteServiceBindingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteServiceBindingURL")
	}
