...
func (o *RetrieveServiceBindingURL) WithBasePath(bp string) *RetrieveServiceBindingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RetrieveServiceBindingURL) Build() (*url.URL, error) {
	...
	var _path = "/service_bindings/{guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on RetrieveServiceBindingURL")
	}
...
func (o *RetrieveServiceBindingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveServiceBindingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveServiceBindingURL")
	}
