...
// NewDeleteServiceBindingParams creates a new DeleteServiceBindingParams object
// no default values defined in spec.
func NewDeleteServiceBindingParams() DeleteServiceBindingParams {

	return DeleteServiceBindingParams{}
}

// DeleteServiceBindingParams contains all the bound params for the delete service binding operation
...
func (o *DeleteServiceBindingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteServiceBindingParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
