...
// NewCreateServiceBindingParams creates a new CreateServiceBindingParams object
// no default values defined in spec.
func NewCreateServiceBindingParams() CreateServiceBindingParams {

	return CreateServiceBindingParams{}
}

// CreateServiceBindingParams contains all the bound params for the create service binding operation
...
func (o *CreateServiceBindingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateServiceBindingRequest
