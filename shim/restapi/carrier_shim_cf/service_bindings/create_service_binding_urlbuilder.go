...
func (o *CreateServiceBindingURL) WithBasePath(bp string) *CreateServiceBindingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateServiceBindingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateServiceBindingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateServiceBindingURL")
	}
