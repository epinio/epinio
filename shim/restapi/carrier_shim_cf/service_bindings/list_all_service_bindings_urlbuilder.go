...
func (o *ListAllServiceBindingsURL) WithBasePath(bp string) *ListAllServiceBindingsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllServiceBindingsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllServiceBindingsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllServiceBindingsURL")
	}
