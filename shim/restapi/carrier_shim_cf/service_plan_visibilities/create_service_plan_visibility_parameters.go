...
// NewCreateServicePlanVisibilityParams creates a new CreateServicePlanVisibilityParams object
// no default values defined in spec.
func NewCreateServicePlanVisibilityParams() CreateServicePlanVisibilityParams {

	return CreateServicePlanVisibilityParams{}
}

// CreateServicePlanVisibilityParams contains all the bound params for the create service plan visibility operation
// typically these are obtained from a http.Request
//
// swagger:parameters createServicePlanVisibility
type CreateServicePlanVisibilityParams struct {
	...
	/*An object instance that is serialized and sent as the request body.
	  ...
	  In: body
	*/
	Value *models.CreateServicePlanVisibilityRequest
}
...
func (o *CreateServicePlanVisibilityParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateServicePlanVisibilityRequest
