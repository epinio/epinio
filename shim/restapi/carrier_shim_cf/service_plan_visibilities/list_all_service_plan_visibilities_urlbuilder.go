...
func (o *ListAllServicePlanVisibilitiesURL) Build() (*url.URL, error) {
	...
	var _path = "/service_plan_visibilities"
...
func (o *ListAllServicePlanVisibilitiesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllServicePlanVisibilitiesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllServicePlanVisibilitiesURL")
	}
