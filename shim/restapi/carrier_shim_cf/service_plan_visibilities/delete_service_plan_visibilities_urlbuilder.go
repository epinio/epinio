...
type DeleteServicePlanVisibilitiesURL struct {
	GUID string
...
func (o *DeleteServicePlanVisibilitiesURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on DeleteServicePlanVisibilitiesURL")
	}
...
func (o *DeleteServicePlanVisibilitiesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteServicePlanVisibilitiesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteServicePlanVisibilitiesURL")
	}
