...
// NewUpdateServicePlanVisibilityParams creates a new UpdateServicePlanVisibilityParams object
// no default values defined in spec.
func NewUpdateServicePlanVisibilityParams() UpdateServicePlanVisibilityParams {

	return UpdateServicePlanVisibilityParams{}
}

// UpdateServicePlanVisibilityParams contains all the bound params for the update service plan visibility operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateServicePlanVisibility
type UpdateServicePlanVisibilityParams struct {

	// HTTP Request Object
	HTTPRequest *http.Request `json:"-"`

	/*The guid parameter is used as a part of the request URL: '/v2/service_plan_visibilities/:guid'
	  Required: true
	  In: path
	*/
	GUID string
	/*An object instance that is serialized and sent as the request body.
	  ...
	  In: body
	*/
	Value *models.UpdateServicePlanVisibilityRequest
}
...
func (o *UpdateServicePlanVisibilityParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateServicePlanVisibilityRequest
...
func (o *UpdateServicePlanVisibilityParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
