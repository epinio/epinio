...
// NewDeleteServicePlanVisibilitiesParams creates a new DeleteServicePlanVisibilitiesParams object
// no default values defined in spec.
func NewDeleteServicePlanVisibilitiesParams() DeleteServicePlanVisibilitiesParams {

	return DeleteServicePlanVisibilitiesParams{}
}

// DeleteServicePlanVisibilitiesParams contains all the bound params for the delete service plan visibilities operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteServicePlanVisibilities
type DeleteServicePlanVisibilitiesParams struct {
...
func (o *DeleteServicePlanVisibilitiesParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
