...
// NewRetrieveServicePlanVisibilityParams creates a new RetrieveServicePlanVisibilityParams object
// no default values defined in spec.
func NewRetrieveServicePlanVisibilityParams() RetrieveServicePlanVisibilityParams {

	return RetrieveServicePlanVisibilityParams{}
}

// RetrieveServicePlanVisibilityParams contains all the bound params for the retrieve service plan visibility operation
// typically these are obtained from a http.Request
//
// swagger:parameters retrieveServicePlanVisibility
type RetrieveServicePlanVisibilityParams struct {
...
func (o *RetrieveServicePlanVisibilityParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
