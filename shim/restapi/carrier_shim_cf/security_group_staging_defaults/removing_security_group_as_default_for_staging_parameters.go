...
// NewRemovingSecurityGroupAsDefaultForStagingParams creates a new RemovingSecurityGroupAsDefaultForStagingParams object
// no default values defined in spec.
func NewRemovingSecurityGroupAsDefaultForStagingParams() RemovingSecurityGroupAsDefaultForStagingParams {

	return RemovingSecurityGroupAsDefaultForStagingParams{}
}

// RemovingSecurityGroupAsDefaultForStagingParams contains all the bound params for the removing security group as default for staging operation
...
func (o *RemovingSecurityGroupAsDefaultForStagingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RemovingSecurityGroupAsDefaultForStagingParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
