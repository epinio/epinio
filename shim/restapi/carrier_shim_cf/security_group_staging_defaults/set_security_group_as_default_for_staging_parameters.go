...
// NewSetSecurityGroupAsDefaultForStagingParams creates a new SetSecurityGroupAsDefaultForStagingParams object
// no default values defined in spec.
func NewSetSecurityGroupAsDefaultForStagingParams() SetSecurityGroupAsDefaultForStagingParams {

	return SetSecurityGroupAsDefaultForStagingParams{}
}

// SetSecurityGroupAsDefaultForStagingParams contains all the bound params for the set security group as default for staging operation
...
func (o *SetSecurityGroupAsDefaultForStagingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SetSecurityGroupAsDefaultForStagingParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
