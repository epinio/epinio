...
// NewCreateUserProvidedServiceInstanceParams creates a new CreateUserProvidedServiceInstanceParams object
// no default values defined in spec.
func NewCreateUserProvidedServiceInstanceParams() CreateUserProvidedServiceInstanceParams {

	return CreateUserProvidedServiceInstanceParams{}
}

// CreateUserProvidedServiceInstanceParams contains all the bound params for the create user provided service instance operation
...
func (o *CreateUserProvidedServiceInstanceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateUserProvidedServiceInstanceRequest
