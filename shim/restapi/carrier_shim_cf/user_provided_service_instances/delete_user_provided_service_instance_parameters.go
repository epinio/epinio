...
// NewDeleteUserProvidedServiceInstanceParams creates a new DeleteUserProvidedServiceInstanceParams object
// no default values defined in spec.
func NewDeleteUserProvidedServiceInstanceParams() DeleteUserProvidedServiceInstanceParams {

	return DeleteUserProvidedServiceInstanceParams{}
}

// DeleteUserProvidedServiceInstanceParams contains all the bound params for the delete user provided service instance operation
...
func (o *DeleteUserProvidedServiceInstanceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
