...
// NewRetrieveUserProvidedServiceInstanceParams creates a new RetrieveUserProvidedServiceInstanceParams object
// no default values defined in spec.
func NewRetrieveUserProvidedServiceInstanceParams() RetrieveUserProvidedServiceInstanceParams {

	return RetrieveUserProvidedServiceInstanceParams{}
}

// RetrieveUserProvidedServiceInstanceParams contains all the bound params for the retrieve user provided service instance operation
...
func (o *RetrieveUserProvidedServiceInstanceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
