...
// NewListAllServiceBindingsForUserProvidedServiceInstanceParams creates a new ListAllServiceBindingsForUserProvidedServiceInstanceParams object
...
func NewListAllServiceBindingsForUserProvidedServiceInstanceParams() ListAllServiceBindingsForUserProvidedServiceInstanceParams {
	...
	return ListAllServiceBindingsForUserProvidedServiceInstanceParams{}
}

// ListAllServiceBindingsForUserProvidedServiceInstanceParams contains all the bound params for the list all service bindings for user provided service instance operation
...
func (o *ListAllServiceBindingsForUserProvidedServiceInstanceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
