...
func (o *ListAllUserProvidedServiceInstancesURL) Build() (*url.URL, error) {
	...
	var _path = "/user_provided_service_instances"
...
func (o *ListAllUserProvidedServiceInstancesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllUserProvidedServiceInstancesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllUserProvidedServiceInstancesURL")
	}
