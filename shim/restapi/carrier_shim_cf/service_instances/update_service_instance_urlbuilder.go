...
func (o *UpdateServiceInstanceURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on UpdateServiceInstanceURL")
	}
...
func (o *UpdateServiceInstanceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateServiceInstanceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateServiceInstanceURL")
	}
