...
// NewRetrieveServiceInstanceParams creates a new RetrieveServiceInstanceParams object
// no default values defined in spec.
func NewRetrieveServiceInstanceParams() RetrieveServiceInstanceParams {

	return RetrieveServiceInstanceParams{}
}

// RetrieveServiceInstanceParams contains all the bound params for the retrieve service instance operation
...
func (o *RetrieveServiceInstanceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
