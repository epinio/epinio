...
// NewListAllServiceBindingsForServiceInstanceParams creates a new ListAllServiceBindingsForServiceInstanceParams object
// no default values defined in spec.
func NewListAllServiceBindingsForServiceInstanceParams() ListAllServiceBindingsForServiceInstanceParams {

	return ListAllServiceBindingsForServiceInstanceParams{}
}

// ListAllServiceBindingsForServiceInstanceParams contains all the bound params for the list all service bindings for service instance operation
...
func (o *ListAllServiceBindingsForServiceInstanceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
