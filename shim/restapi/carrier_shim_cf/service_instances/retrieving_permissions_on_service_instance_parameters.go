...
// NewRetrievingPermissionsOnServiceInstanceParams creates a new RetrievingPermissionsOnServiceInstanceParams object
// no default values defined in spec.
func NewRetrievingPermissionsOnServiceInstanceParams() RetrievingPermissionsOnServiceInstanceParams {

	return RetrievingPermissionsOnServiceInstanceParams{}
}

// RetrievingPermissionsOnServiceInstanceParams contains all the bound params for the retrieving permissions on service instance operation
...
func (o *RetrievingPermissionsOnServiceInstanceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
