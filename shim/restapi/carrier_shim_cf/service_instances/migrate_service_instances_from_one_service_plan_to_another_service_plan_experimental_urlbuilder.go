...
func (o *MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalURL) Build() (*url.URL, error) {
	...
	var _path = "/service_plans/{guid}/service_instances"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalURL")
	}
...
func (o *MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalURL")
	}
