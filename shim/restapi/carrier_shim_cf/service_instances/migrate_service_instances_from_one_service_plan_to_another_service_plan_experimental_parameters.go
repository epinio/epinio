...
// NewMigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalParams creates a new MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalParams object
...
func NewMigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalParams() MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalParams {
	...
	return MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalParams{}
}

// MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalParams contains all the bound params for the migrate service instances from one service plan to another service plan experimental operation
...
func (o *MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalRequest
...
func (o *MigrateServiceInstancesFromOneServicePlanToAnotherServicePlanExperimentalParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
