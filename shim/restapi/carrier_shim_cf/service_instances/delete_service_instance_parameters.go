...
// DeleteServiceInstanceParams contains all the bound params for the delete service instance operation
...
func (o *DeleteServiceInstanceParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
