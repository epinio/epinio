...
func (o *RemoveUserFromOrganizationURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveUserFromOrganizationURL")
	}
	...
	if userGUID != "" {
		...
		return nil, errors.New("userGuid is required on RemoveUserFromOrganizationURL")
	}
...
func (o *RemoveUserFromOrganizationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveUserFromOrganizationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveUserFromOrganizationURL")
	}
