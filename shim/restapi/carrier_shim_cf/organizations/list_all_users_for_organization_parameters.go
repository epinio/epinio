...
// NewListAllUsersForOrganizationParams creates a new ListAllUsersForOrganizationParams object
// no default values defined in spec.
func NewListAllUsersForOrganizationParams() ListAllUsersForOrganizationParams {

	return ListAllUsersForOrganizationParams{}
}

// ListAllUsersForOrganizationParams contains all the bound params for the list all users for organization operation
...
func (o *ListAllUsersForOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
