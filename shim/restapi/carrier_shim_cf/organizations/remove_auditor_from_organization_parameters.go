...
// NewRemoveAuditorFromOrganizationParams creates a new RemoveAuditorFromOrganizationParams object
// no default values defined in spec.
func NewRemoveAuditorFromOrganizationParams() RemoveAuditorFromOrganizationParams {

	return RemoveAuditorFromOrganizationParams{}
}

// RemoveAuditorFromOrganizationParams contains all the bound params for the remove auditor from organization operation
...
func (o *RemoveAuditorFromOrganizationParams) bindAuditorGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RemoveAuditorFromOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
