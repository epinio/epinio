...
// NewRetrievingOrganizationMemoryUsageParams creates a new RetrievingOrganizationMemoryUsageParams object
// no default values defined in spec.
func NewRetrievingOrganizationMemoryUsageParams() RetrievingOrganizationMemoryUsageParams {

	return RetrievingOrganizationMemoryUsageParams{}
}

// RetrievingOrganizationMemoryUsageParams contains all the bound params for the retrieving organization memory usage operation
...
func (o *RetrievingOrganizationMemoryUsageParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
