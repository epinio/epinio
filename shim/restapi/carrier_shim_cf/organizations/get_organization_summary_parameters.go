...
// NewGetOrganizationSummaryParams creates a new GetOrganizationSummaryParams object
// no default values defined in spec.
func NewGetOrganizationSummaryParams() GetOrganizationSummaryParams {

	return GetOrganizationSummaryParams{}
}

// GetOrganizationSummaryParams contains all the bound params for the get organization summary operation
...
func (o *GetOrganizationSummaryParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
