...
// NewRemoveManagerFromOrganizationParams creates a new RemoveManagerFromOrganizationParams object
// no default values defined in spec.
func NewRemoveManagerFromOrganizationParams() RemoveManagerFromOrganizationParams {

	return RemoveManagerFromOrganizationParams{}
}

// RemoveManagerFromOrganizationParams contains all the bound params for the remove manager from organization operation
...
func (o *RemoveManagerFromOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RemoveManagerFromOrganizationParams) bindManagerGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
