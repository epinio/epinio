...
// NewAssociateManagerWithOrganizationParams creates a new AssociateManagerWithOrganizationParams object
// no default values defined in spec.
func NewAssociateManagerWithOrganizationParams() AssociateManagerWithOrganizationParams {

	return AssociateManagerWithOrganizationParams{}
}

// AssociateManagerWithOrganizationParams contains all the bound params for the associate manager with organization operation
...
func (o *AssociateManagerWithOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AssociateManagerWithOrganizationParams) bindManagerGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
