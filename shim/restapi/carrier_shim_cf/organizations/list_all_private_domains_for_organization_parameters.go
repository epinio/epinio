...
// NewListAllPrivateDomainsForOrganizationParams creates a new ListAllPrivateDomainsForOrganizationParams object
// no default values defined in spec.
func NewListAllPrivateDomainsForOrganizationParams() ListAllPrivateDomainsForOrganizationParams {

	return ListAllPrivateDomainsForOrganizationParams{}
}

// ListAllPrivateDomainsForOrganizationParams contains all the bound params for the list all private domains for organization operation
...
func (o *ListAllPrivateDomainsForOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
