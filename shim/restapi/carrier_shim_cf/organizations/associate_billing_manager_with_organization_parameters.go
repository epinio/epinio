...
// NewAssociateBillingManagerWithOrganizationParams creates a new AssociateBillingManagerWithOrganizationParams object
// no default values defined in spec.
func NewAssociateBillingManagerWithOrganizationParams() AssociateBillingManagerWithOrganizationParams {

	return AssociateBillingManagerWithOrganizationParams{}
}

// AssociateBillingManagerWithOrganizationParams contains all the bound params for the associate billing manager with organization operation
...
func (o *AssociateBillingManagerWithOrganizationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	rBillingManagerGUID, rhkBillingManagerGUID, _ := route.Params.GetOK("billing_manager_guid")
	if err := o.bindBillingManagerGUID(rBillingManagerGUID, rhkBillingManagerGUID, route.Formats); err != nil {
		res = append(res, err)
	}
...
// bindBillingManagerGUID binds and validates parameter BillingManagerGUID from path.
func (o *AssociateBillingManagerWithOrganizationParams) bindBillingManagerGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	o.BillingManagerGUID = raw

	return nil
}

// bindGUID binds and validates parameter GUID from path.
func (o *AssociateBillingManagerWithOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
