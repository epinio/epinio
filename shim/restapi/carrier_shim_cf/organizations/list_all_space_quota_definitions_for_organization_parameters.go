...
// NewListAllSpaceQuotaDefinitionsForOrganizationParams creates a new ListAllSpaceQuotaDefinitionsForOrganizationParams object
// no default values defined in spec.
func NewListAllSpaceQuotaDefinitionsForOrganizationParams() ListAllSpaceQuotaDefinitionsForOrganizationParams {

	return ListAllSpaceQuotaDefinitionsForOrganizationParams{}
}

// ListAllSpaceQuotaDefinitionsForOrganizationParams contains all the bound params for the list all space quota definitions for organization operation
...
func (o *ListAllSpaceQuotaDefinitionsForOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
