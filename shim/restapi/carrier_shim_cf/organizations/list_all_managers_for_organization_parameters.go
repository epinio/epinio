...
// NewListAllManagersForOrganizationParams creates a new ListAllManagersForOrganizationParams object
// no default values defined in spec.
func NewListAllManagersForOrganizationParams() ListAllManagersForOrganizationParams {

	return ListAllManagersForOrganizationParams{}
}

// ListAllManagersForOrganizationParams contains all the bound params for the list all managers for organization operation
...
func (o *ListAllManagersForOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
