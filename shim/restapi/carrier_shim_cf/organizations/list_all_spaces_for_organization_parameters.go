...
// NewListAllSpacesForOrganizationParams creates a new ListAllSpacesForOrganizationParams object
// no default values defined in spec.
func NewListAllSpacesForOrganizationParams() ListAllSpacesForOrganizationParams {

	return ListAllSpacesForOrganizationParams{}
}

// ListAllSpacesForOrganizationParams contains all the bound params for the list all spaces for organization operation
...
func (o *ListAllSpacesForOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
