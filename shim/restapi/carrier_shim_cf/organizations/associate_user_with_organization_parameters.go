...
// NewAssociateUserWithOrganizationParams creates a new AssociateUserWithOrganizationParams object
// no default values defined in spec.
func NewAssociateUserWithOrganizationParams() AssociateUserWithOrganizationParams {

	return AssociateUserWithOrganizationParams{}
}

// AssociateUserWithOrganizationParams contains all the bound params for the associate user with organization operation
...
func (o *AssociateUserWithOrganizationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	rUserGUID, rhkUserGUID, _ := route.Params.GetOK("user_guid")
	if err := o.bindUserGUID(rUserGUID, rhkUserGUID, route.Formats); err != nil {
		res = append(res, err)
	}
...
func (o *AssociateUserWithOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
// bindUserGUID binds and validates parameter UserGUID from path.
func (o *AssociateUserWithOrganizationParams) bindUserGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
