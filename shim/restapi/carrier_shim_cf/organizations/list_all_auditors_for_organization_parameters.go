...
// NewListAllAuditorsForOrganizationParams creates a new ListAllAuditorsForOrganizationParams object
// no default values defined in spec.
func NewListAllAuditorsForOrganizationParams() ListAllAuditorsForOrganizationParams {

	return ListAllAuditorsForOrganizationParams{}
}

// ListAllAuditorsForOrganizationParams contains all the bound params for the list all auditors for organization operation
...
func (o *ListAllAuditorsForOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
