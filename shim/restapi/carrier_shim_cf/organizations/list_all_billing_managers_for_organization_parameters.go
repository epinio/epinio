...
// NewListAllBillingManagersForOrganizationParams creates a new ListAllBillingManagersForOrganizationParams object
// no default values defined in spec.
func NewListAllBillingManagersForOrganizationParams() ListAllBillingManagersForOrganizationParams {

	return ListAllBillingManagersForOrganizationParams{}
}

// ListAllBillingManagersForOrganizationParams contains all the bound params for the list all billing managers for organization operation
...
func (o *ListAllBillingManagersForOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
