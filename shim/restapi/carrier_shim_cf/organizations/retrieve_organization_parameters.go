...
// NewRetrieveOrganizationParams creates a new RetrieveOrganizationParams object
// no default values defined in spec.
func NewRetrieveOrganizationParams() RetrieveOrganizationParams {

	return RetrieveOrganizationParams{}
}

// RetrieveOrganizationParams contains all the bound params for the retrieve organization operation
...
func (o *RetrieveOrganizationParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
