...
// NewListAllDomainsForOrganizationDeprecatedParams creates a new ListAllDomainsForOrganizationDeprecatedParams object
// no default values defined in spec.
func NewListAllDomainsForOrganizationDeprecatedParams() ListAllDomainsForOrganizationDeprecatedParams {

	return ListAllDomainsForOrganizationDeprecatedParams{}
}

// ListAllDomainsForOrganizationDeprecatedParams contains all the bound params for the list all domains for organization deprecated operation
...
func (o *ListAllDomainsForOrganizationDeprecatedParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
