...
func (o *RemoveManagerFromOrganizationURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveManagerFromOrganizationURL")
	}
	...
	if managerGUID != "" {
		...
		return nil, errors.New("managerGuid is required on RemoveManagerFromOrganizationURL")
	}
...
func (o *RemoveManagerFromOrganizationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveManagerFromOrganizationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveManagerFromOrganizationURL")
	}
