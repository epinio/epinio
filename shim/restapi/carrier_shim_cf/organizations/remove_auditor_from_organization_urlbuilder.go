...
func (o *RemoveAuditorFromOrganizationURL) Build() (*url.URL, error) {
	...
	if auditorGUID != "" {
		...
		return nil, errors.New("auditorGuid is required on RemoveAuditorFromOrganizationURL")
	}
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveAuditorFromOrganizationURL")
	}
...
func (o *RemoveAuditorFromOrganizationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveAuditorFromOrganizationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveAuditorFromOrganizationURL")
	}
