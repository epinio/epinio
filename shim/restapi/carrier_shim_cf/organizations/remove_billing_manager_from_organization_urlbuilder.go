...
func (o *RemoveBillingManagerFromOrganizationURL) Build() (*url.URL, error) {
	...
	if billingManagerGUID != "" {
		...
		return nil, errors.New("billingManagerGuid is required on RemoveBillingManagerFromOrganizationURL")
	}
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveBillingManagerFromOrganizationURL")
	}
...
func (o *RemoveBillingManagerFromOrganizationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveBillingManagerFromOrganizationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveBillingManagerFromOrganizationURL")
	}
