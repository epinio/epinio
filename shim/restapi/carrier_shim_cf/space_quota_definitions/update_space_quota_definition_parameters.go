...
// NewUpdateSpaceQuotaDefinitionParams creates a new UpdateSpaceQuotaDefinitionParams object
// no default values defined in spec.
func NewUpdateSpaceQuotaDefinitionParams() UpdateSpaceQuotaDefinitionParams {

	return UpdateSpaceQuotaDefinitionParams{}
}

// UpdateSpaceQuotaDefinitionParams contains all the bound params for the update space quota definition operation
...
func (o *UpdateSpaceQuotaDefinitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateSpaceQuotaDefinitionRequest
...
func (o *UpdateSpaceQuotaDefinitionParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
