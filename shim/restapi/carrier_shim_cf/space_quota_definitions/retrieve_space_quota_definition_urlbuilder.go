...
func (o *RetrieveSpaceQuotaDefinitionURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RetrieveSpaceQuotaDefinitionURL")
	}
...
func (o *RetrieveSpaceQuotaDefinitionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveSpaceQuotaDefinitionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveSpaceQuotaDefinitionURL")
	}
