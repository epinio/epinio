...
// NewRemoveSpaceFromSpaceQuotaDefinitionParams creates a new RemoveSpaceFromSpaceQuotaDefinitionParams object
// no default values defined in spec.
func NewRemoveSpaceFromSpaceQuotaDefinitionParams() RemoveSpaceFromSpaceQuotaDefinitionParams {

	return RemoveSpaceFromSpaceQuotaDefinitionParams{}
}

// RemoveSpaceFromSpaceQuotaDefinitionParams contains all the bound params for the remove space from space quota definition operation
...
func (o *RemoveSpaceFromSpaceQuotaDefinitionParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RemoveSpaceFromSpaceQuotaDefinitionParams) bindSpaceGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
