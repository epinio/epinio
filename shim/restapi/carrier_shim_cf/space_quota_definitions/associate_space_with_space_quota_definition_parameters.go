...
// NewAssociateSpaceWithSpaceQuotaDefinitionParams creates a new AssociateSpaceWithSpaceQuotaDefinitionParams object
// no default values defined in spec.
func NewAssociateSpaceWithSpaceQuotaDefinitionParams() AssociateSpaceWithSpaceQuotaDefinitionParams {

	return AssociateSpaceWithSpaceQuotaDefinitionParams{}
}

// AssociateSpaceWithSpaceQuotaDefinitionParams contains all the bound params for the associate space with space quota definition operation
...
func (o *AssociateSpaceWithSpaceQuotaDefinitionParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AssociateSpaceWithSpaceQuotaDefinitionParams) bindSpaceGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
