...
// NewRetrieveSpaceQuotaDefinitionParams creates a new RetrieveSpaceQuotaDefinitionParams object
// no default values defined in spec.
func NewRetrieveSpaceQuotaDefinitionParams() RetrieveSpaceQuotaDefinitionParams {

	return RetrieveSpaceQuotaDefinitionParams{}
}

// RetrieveSpaceQuotaDefinitionParams contains all the bound params for the retrieve space quota definition operation
...
func (o *RetrieveSpaceQuotaDefinitionParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
