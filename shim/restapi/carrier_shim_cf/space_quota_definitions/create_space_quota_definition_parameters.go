...
// NewCreateSpaceQuotaDefinitionParams creates a new CreateSpaceQuotaDefinitionParams object
// no default values defined in spec.
func NewCreateSpaceQuotaDefinitionParams() CreateSpaceQuotaDefinitionParams {

	return CreateSpaceQuotaDefinitionParams{}
}

// CreateSpaceQuotaDefinitionParams contains all the bound params for the create space quota definition operation
...
func (o *CreateSpaceQuotaDefinitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateSpaceQuotaDefinitionRequest
