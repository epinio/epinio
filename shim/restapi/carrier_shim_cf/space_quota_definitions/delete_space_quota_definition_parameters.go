...
// NewDeleteSpaceQuotaDefinitionParams creates a new DeleteSpaceQuotaDefinitionParams object
// no default values defined in spec.
func NewDeleteSpaceQuotaDefinitionParams() DeleteSpaceQuotaDefinitionParams {

	return DeleteSpaceQuotaDefinitionParams{}
}

// DeleteSpaceQuotaDefinitionParams contains all the bound params for the delete space quota definition operation
...
func (o *DeleteSpaceQuotaDefinitionParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
