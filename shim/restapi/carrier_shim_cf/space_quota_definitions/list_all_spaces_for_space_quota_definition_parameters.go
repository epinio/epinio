...
// NewListAllSpacesForSpaceQuotaDefinitionParams creates a new ListAllSpacesForSpaceQuotaDefinitionParams object
// no default values defined in spec.
func NewListAllSpacesForSpaceQuotaDefinitionParams() ListAllSpacesForSpaceQuotaDefinitionParams {

	return ListAllSpacesForSpaceQuotaDefinitionParams{}
}

// ListAllSpacesForSpaceQuotaDefinitionParams contains all the bound params for the list all spaces for space quota definition operation
...
func (o *ListAllSpacesForSpaceQuotaDefinitionParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
