...
func (o *RemoveSpaceFromSpaceQuotaDefinitionURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveSpaceFromSpaceQuotaDefinitionURL")
	}
	...
	if spaceGUID != "" {
		...
		return nil, errors.New("spaceGuid is required on RemoveSpaceFromSpaceQuotaDefinitionURL")
	}
...
func (o *RemoveSpaceFromSpaceQuotaDefinitionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveSpaceFromSpaceQuotaDefinitionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveSpaceFromSpaceQuotaDefinitionURL")
	}
