...
// RetrieveEventParams contains all the bound params for the retrieve event operation
...
type RetrieveEventParams struct {
	...
	/*The guid parameter is used as a part of the request URL: '/v2/events/:guid'
	  Required: true
	  In: path
	*/
	GUID string
...
func (o *RetrieveEventParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
