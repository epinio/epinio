...
func (o *RetrieveSecurityGroupURL) WithBasePath(bp string) *RetrieveSecurityGroupURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *RetrieveSecurityGroupURL) Build() (*url.URL, error) {
	...
	var _path = "/security_groups/{guid}"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on RetrieveSecurityGroupURL")
	}
...
func (o *RetrieveSecurityGroupURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RetrieveSecurityGroupURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RetrieveSecurityGroupURL")
	}
