...
// UpdateSecurityGroupParams contains all the bound params for the update security group operation
...
func (o *UpdateSecurityGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateSecurityGroupRequest
...
func (o *UpdateSecurityGroupParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
