...
// NewRemoveSpaceFromSecurityGroupParams creates a new RemoveSpaceFromSecurityGroupParams object
// no default values defined in spec.
func NewRemoveSpaceFromSecurityGroupParams() RemoveSpaceFromSecurityGroupParams {

	return RemoveSpaceFromSecurityGroupParams{}
}

// RemoveSpaceFromSecurityGroupParams contains all the bound params for the remove space from security group operation
...
func (o *RemoveSpaceFromSecurityGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RemoveSpaceFromSecurityGroupParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RemoveSpaceFromSecurityGroupParams) bindSpaceGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
