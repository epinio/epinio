...
func (o *DeleteSecurityGroupURL) WithBasePath(bp string) *DeleteSecurityGroupURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteSecurityGroupURL) Build() (*url.URL, error) {
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on DeleteSecurityGroupURL")
	}
...
func (o *DeleteSecurityGroupURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteSecurityGroupURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteSecurityGroupURL")
	}
