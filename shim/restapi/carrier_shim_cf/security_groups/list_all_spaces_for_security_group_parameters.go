...
// NewListAllSpacesForSecurityGroupParams creates a new ListAllSpacesForSecurityGroupParams object
// no default values defined in spec.
func NewListAllSpacesForSecurityGroupParams() ListAllSpacesForSecurityGroupParams {

	return ListAllSpacesForSecurityGroupParams{}
}

// ListAllSpacesForSecurityGroupParams contains all the bound params for the list all spaces for security group operation
...
func (o *ListAllSpacesForSecurityGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllSpacesForSecurityGroupParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
