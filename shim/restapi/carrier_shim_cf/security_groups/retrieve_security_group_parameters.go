...
// NewRetrieveSecurityGroupParams creates a new RetrieveSecurityGroupParams object
// no default values defined in spec.
func NewRetrieveSecurityGroupParams() RetrieveSecurityGroupParams {

	return RetrieveSecurityGroupParams{}
}

// RetrieveSecurityGroupParams contains all the bound params for the retrieve security group operation
...
func (o *RetrieveSecurityGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RetrieveSecurityGroupParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
