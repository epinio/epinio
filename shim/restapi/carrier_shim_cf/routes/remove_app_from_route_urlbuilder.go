...
func (o *RemoveAppFromRouteURL) Build() (*url.URL, error) {
	...
	if appGUID != "" {
		...
		return nil, errors.New("appGuid is required on RemoveAppFromRouteURL")
	}
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on RemoveAppFromRouteURL")
	}
...
func (o *RemoveAppFromRouteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveAppFromRouteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveAppFromRouteURL")
	}
