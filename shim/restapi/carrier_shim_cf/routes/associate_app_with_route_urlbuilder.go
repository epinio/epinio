...
func (o *AssociateAppWithRouteURL) WithBasePath(bp string) *AssociateAppWithRouteURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *AssociateAppWithRouteURL) Build() (*url.URL, error) {
	...
	var _path = "/routes/{guid}/apps/{app_guid}"

	appGUID := o.AppGUID
	if appGUID != "" {
		_path = strings.Replace(_path, "{app_guid}", appGUID, -1)
	} else {
		return nil, errors.New("appGuid is required on AssociateAppWithRouteURL")
	}
	...
	if guid != "" {
		...
		return nil, errors.New("guid is required on AssociateAppWithRouteURL")
	}
...
func (o *AssociateAppWithRouteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AssociateAppWithRouteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AssociateAppWithRouteURL")
	}
