...
func (o *ListAllAppsForRouteURL) WithBasePath(bp string) *ListAllAppsForRouteURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllAppsForRouteURL) Build() (*url.URL, error) {
	...
	var _path = "/routes/{guid}/apps"

	guid := o.GUID
	if guid != "" {
		_path = strings.Replace(_path, "{guid}", guid, -1)
	} else {
		return nil, errors.New("guid is required on ListAllAppsForRouteURL")
	}
...
func (o *ListAllAppsForRouteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllAppsForRouteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllAppsForRouteURL")
	}
