...
// DeleteRouteParams contains all the bound params for the delete route operation
...
func (o *DeleteRouteParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
