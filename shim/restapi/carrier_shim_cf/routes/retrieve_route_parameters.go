...
// NewRetrieveRouteParams creates a new RetrieveRouteParams object
// no default values defined in spec.
func NewRetrieveRouteParams() RetrieveRouteParams {

	return RetrieveRouteParams{}
}

// RetrieveRouteParams contains all the bound params for the retrieve route operation
...
func (o *RetrieveRouteParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
