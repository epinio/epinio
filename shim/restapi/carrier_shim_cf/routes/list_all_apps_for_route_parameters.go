...
// NewListAllAppsForRouteParams creates a new ListAllAppsForRouteParams object
// no default values defined in spec.
func NewListAllAppsForRouteParams() ListAllAppsForRouteParams {

	return ListAllAppsForRouteParams{}
}

// ListAllAppsForRouteParams contains all the bound params for the list all apps for route operation
...
func (o *ListAllAppsForRouteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListAllAppsForRouteParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
