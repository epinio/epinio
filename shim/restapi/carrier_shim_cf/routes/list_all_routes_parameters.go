...
// NewListAllRoutesParams creates a new ListAllRoutesParams object
// no default values defined in spec.
func NewListAllRoutesParams() ListAllRoutesParams {

	return ListAllRoutesParams{}
}

// ListAllRoutesParams contains all the bound params for the list all routes operation
