...
// NewRetrieveSharedDomainParams creates a new RetrieveSharedDomainParams object
// no default values defined in spec.
func NewRetrieveSharedDomainParams() RetrieveSharedDomainParams {

	return RetrieveSharedDomainParams{}
}

// RetrieveSharedDomainParams contains all the bound params for the retrieve shared domain operation
...
func (o *RetrieveSharedDomainParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
