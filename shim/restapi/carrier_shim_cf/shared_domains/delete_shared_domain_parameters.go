...
// NewDeleteSharedDomainParams creates a new DeleteSharedDomainParams object
// no default values defined in spec.
func NewDeleteSharedDomainParams() DeleteSharedDomainParams {

	return DeleteSharedDomainParams{}
}

// DeleteSharedDomainParams contains all the bound params for the delete shared domain operation
...
func (o *DeleteSharedDomainParams) bindGUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
