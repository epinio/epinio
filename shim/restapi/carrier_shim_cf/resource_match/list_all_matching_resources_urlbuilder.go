...
func (o *ListAllMatchingResourcesURL) WithBasePath(bp string) *ListAllMatchingResourcesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListAllMatchingResourcesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListAllMatchingResourcesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListAllMatchingResourcesURL")
	}
