...
Epinio documentation is organised into these four quadrants.

**Tutorials** take you by the hand through a series of steps on how to install epinio in various kubernetes distros, how to push an application of various languages etc. 
**How-to-guides** How-to-guides explain steps to solve specific problems like how to create a redis database using epinio etc. 
**Topic guides** discuss components of Epinio at a very high level like about linkerd, traefik etc. 
**Reference** provides information about Epinio CLI docs and Epinio API docs. 
