...
For a trial deployment as described above the certificate securing the API will
be generated by the underlying cluster, and self-signed, and its CA certificate
is stored in the configuration to allow verification.
